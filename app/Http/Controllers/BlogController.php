...
{
    $blogs = Blog::where('category_id', '!=', '34')->orderBy('id', 'desc')->paginate(10);
    $blog_categories = BlogCategory::all();
    ...
    if ($request->ajax()) {
        return view('frontend.blogs.index', compact('blogs', 'blog_categories', 'metaDescription', 'metatitle', 'metaKey'))->render();
    }
