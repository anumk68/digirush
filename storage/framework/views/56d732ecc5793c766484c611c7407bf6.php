            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="contact-form">
                        <form action="<?php echo e(route('contactform.submit')); ?>" method="post" class="form-horizontal"
                            id="contactFormss">
                            <?php echo csrf_field(); ?>
                            <div class="section-heading mb-30">
                                        ...
                                        <div class="form-field input-group-prepend input_preport">
                                            <div class="input-group-prepend">
                                                <select name="countryCode" style="width:120px;">
                                                    ...
                                                    <option data-countryCode="US" value="1" <?php echo e(old('countryCode') == '1' ? 'selected' : ''); ?>>
                                                        US (+1)</option>
                                                </select>
                                            </div>
                                            <input type="text" id="phone_fulls" name="mobile_number" minlength="10"
                                                maxlength="10" class="form-control" value="<?php echo e(old('mobile_number')); ?>">
                                        </div>
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12">
                                        <div class="form-field">
                                            <select name="services" id="cars">
                                                ...
                                                <option value="Website Designing" <?php echo e(old('services') == 'Website Designing' ? 'selected' : ''); ?>>
                                                    Website Designing & Development
                                                </option>
                                                <option value="Application Development" <?php echo e(old('services') == 'Application Development' ? 'selected' : ''); ?>>
                                                    Application Development
                                                </option>
                                                <option value="Software Development" <?php echo e(old('services') == 'Software Development' ? 'selected' : ''); ?>>
                                                    Software Development
                                                </option>
                                                <option value="CRM" <?php echo e(old('services') == 'CRM' ? 'selected' : ''); ?>>
                                                    CRM, ERP Development
                                                </option>
                                                <option value="All Digital Marketing Services" <?php echo e(old('services') == 'All Digital Marketing Services' ? 'selected' : ''); ?>>
                                                    All Digital Marketing Services
                                                </option>
                                                <option value="SEO Services" <?php echo e(old('services') == 'SEO Services' ? 'selected' : ''); ?>>
                                                    SEO Services
                                                </option>
                                                <option value="SMO Services" <?php echo e(old('services') == 'SMO Services' ? 'selected' : ''); ?>>
                                                    SMO Services
                                                </option>
                                                <option value="PPC Services" <?php echo e(old('services') == 'PPC Services' ? 'selected' : ''); ?>>
                                                    PPC Services
                                                </option>
                                                <option value="Email Marketing" <?php echo e(old('services') == 'Email Marketing' ? 'selected' : ''); ?>>
                                                    Email Marketing, SMS, Whatsapp Messages, Broadcast Services
                                                </option>
                                                <option value="Graphic Designing" <?php echo e(old('services') == 'Graphic Designing' ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                            <div id="otp-group5" style="display:none;">
                                                                                                                                                                                                                                                                                                                                                <label for="otp">Enter OTP</label>
                                                                                                                                                                                                                                                                                                                                                <input type="text" name="otp" class="form-control" />
                                                                                                                                                                                                                                                                                                                                            </div>
                                                                                                                                                                                                                                                                                                                                            <p id="contact-message" style="color:red; margin-top: 10px;"></p>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            verifyOtpBtn.addEventListener('click', function () {
                ...
                fetch("<?php echo e(route('contactform.submit')); ?>", {
                    method: 'POST',
                    headers: {
...
<?php echo $__env->make('layouts.front.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\rahul\resources\views/frontend/contact.blade.php ENDPATH**/ ?>