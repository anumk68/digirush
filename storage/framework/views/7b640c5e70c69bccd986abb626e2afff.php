        ...
        <div class="row align-items-center">
            <div class="col-md-2">
                <div class="header_landng_logo">
                    <div class="site-logo">
                        <a href="https://digirushsolutions.com"><img src="<?php echo e(custom_asset('front_assets/img/F-Logo.png')); ?>" alt="digirusholution"></a>
                        </div>
                </div>
            </div>
            <div class="col-md-7">
                ...
                <li>
                    <div class="mail_icon">
                        <a href="#"><i class="fa-solid fa-envelope"></i> contact@digirushsolutions.com</a>
                    </div>
                </li>
                    </ul>
                </div>
...
<section class="landing_banner_home" style="background-image: url(<?php echo e(custom_asset('front_assets/img/home-landing-11.jpg')); ?>);">
    <div class="container">
        <div class="row">
            <div class="col-md-7">
    ...
    <form action="<?php echo e(route('homelanding.store')); ?>" method="POST" id="bannerForm">
        <?php echo csrf_field(); ?>
        <input type="hidden" name="type" value="seo-digital-services"> <!-- Correctly include type -->
        <div class="txt_form">
            <h2>Fill The Form Now</h2>
            <img src="<?php echo e(custom_asset('front_assets/img/GET-2.gif')); ?>" alt="">
        </div>

        <div class="row">
            <div class="col-md-6 mb-4">
                <label for="fname">First name*</label>
                <input type="text" id="fname" name="fname" placeholder="First Name" value="<?php echo e(old('fname')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-6 mb-4">
                ...
                <input type="text" id="phone_no" name="phone_no" placeholder="Phone No" value="<?php echo e(old('phone_no')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-6">
                ...
                <input type="email" id="email" name="email" placeholder="Email Address" value="<?php echo e(old('email')); ?>" required>
                ...
                <div class="sponsor-carousel">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide logo_client ">
                            <img src="<?php echo e(custom_asset('front_assets/img/royalcare-logo.jpg')); ?>" alt="client">
                        </div>
                        <div class="swiper-slide logo_client">
                            <img src="<?php echo e(custom_asset('front_assets/img/foryou.png')); ?>" alt="client">
                        </div>
                        <div class="swiper-slide logo_client">
                            <img src="<?php echo e(custom_asset('front_assets/img/sristi_logo.png')); ?>" alt="client">
                        </div>
                        <div class="swiper-slide logo_client">
                            <img src="<?php echo e(custom_asset('front_assets/img/Great-media-1536x733.png')); ?>" alt="client">
                        </div>
                        <div class="swiper-slide logo_client">
                            <img src="<?php echo e(custom_asset('front_assets/img/freebacklinks-logo.png')); ?>" alt="client">
                        </div>
                        <div class="swiper-slide logo_client">
                            <img src="<?php echo e(custom_asset('front_assets/img/bookmy122313223-ticket-180x37-1.png')); ?>" alt="client">
                        </div>
                        <div class="swiper-slide logo_client">
                            <img src="<?php echo e(custom_asset('front_assets/img/airtkt-logo.png')); ?>" alt="client">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row align-items-center">
            <div class="col-md-6">
                <div class="company_img_main">
                    <img src="<?php echo e(custom_asset('front_assets/img/company_landing_1.jpg')); ?>" alt="">
                </div>
            </div>
            <div class="col-md-6">
...
<section class="services_main_home" style="background-image: url(<?php echo e(custom_asset('front_assets/img/service_background.webp')); ?>);">
 <div class="container">
    ...
    <div class="row">
        <div class="col-md-3 mb-4">
            <div class="under_main_specialization">
                <div class="img_specia">
                    <img src="<?php echo e(custom_asset('front_assets/img/coding_1.png')); ?>" alt="">
                </div>
        ...
        <div class="col-md-3 mb-4">
            <div class="under_main_specialization">
                <div class="img_specia">
                    <img src="<?php echo e(custom_asset('front_assets/img/coding_2.png')); ?>" alt="">
                </div>
                <div class="txt_special_lization">
                    <h2>On-Page SEO</h2>
        ...
        <div class="col-md-3 mb-4">
            <div class="under_main_specialization">
                <div class="img_specia">
                    <img src="<?php echo e(custom_asset('front_assets/img/coding_3.png')); ?>" alt="">
                </div>
                <div class="txt_special_lization">
                    <h2>Off-Page SEO</h2>
        ...
        <div class="col-md-3 mb-4">
            <div class="under_main_specialization">
                <div class="img_specia">
                    <img src="<?php echo e(custom_asset('front_assets/img/coding_4.png')); ?>" alt="">
                </div>
                <div class="txt_special_lization">
                    <h2>Technical SEO</h2>
        ...
        <div class="col-md-3 mb-4">
            <div class="under_main_specialization">
                <div class="img_specia">
                    <img src="<?php echo e(custom_asset('front_assets/img/coding_5.png')); ?>" alt="">
                </div>
                <div class="txt_special_lization">
                    <h2>Local SEO</h2>
        ...
        <div class="col-md-3 mb-4">
            <div class="under_main_specialization">
                <div class="img_specia">
                    <img src="<?php echo e(custom_asset('front_assets/img/software.png')); ?>" alt="">
                </div>
                <div class="txt_special_lization">
        ...
        <div class="col-md-3 mb-4">
            <div class="under_main_specialization">
                <div class="img_specia">
                    <img src="<?php echo e(custom_asset('front_assets/img/usability.png')); ?>" alt="">
                </div>
                <div class="txt_special_lization">
        ...
        <div class="col-md-3 mb-4">
            <div class="under_main_specialization">
                <div class="img_specia">
                    <img src="<?php echo e(custom_asset('front_assets/img/coding_8.png')); ?>" alt="">
                </div>
                <div class="txt_special_lization">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 col-md-12 col-12">
                <div class="img_audience">
                    <img src="<?php echo e(custom_asset('front_assets/img/audience_homeee.webp')); ?>" alt="">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row align-items-center">
            <div class="col-md-6">
                <div class="img_feature">
                    <img src="<?php echo e(custom_asset('front_assets/img/feature_1_img.jpg')); ?>" alt="">
                </div>
            </div>
...
<section class="smart_marketing_main padding" style="background-image: url(<?php echo e(custom_asset('front_assets/img/smart_marketing_bg.jpg')); ?>);">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                    <div class="img_marketing_">
                        <img src="<?php echo e(custom_asset('front_assets/img/smart_under.png')); ?>" alt="">
                    </div>
            </div>
        </div>
    </div>
...
<section class="nav_tab_new_session padding landing_nav_home">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 mb-4">
                ...
                <img src="<?php echo e(custom_asset('front_assets/img/greatmedia.jpg')); ?>" alt="img">
                </div>
            </div>
            <div class="col-md-4 mb-4">
                <div class="pills_under_img">
                <img src="<?php echo e(custom_asset('front_assets/img/Babycorngroup.png')); ?>" alt="img">
                </div>
            </div>

            <div class="col-md-4 mb-4">
                <div class="pills_under_img">
                <img src="<?php echo e(custom_asset('front_assets/img/Srishti-Admission-Point-Get-Admission-in-Top-Indian-Universities.jpg')); ?>" alt="img">
                </div>
            </div>
            
            <div class="col-md-4 mb-4">
                <div class="pills_under_img">
                <img src="<?php echo e(custom_asset('front_assets/img/Pragyan-Educational-Research-Skill-Development-Council.jpg')); ?>" alt="img">
                </div>
            </div>
            
            <div class="col-md-4 mb-4">
                <div class="pills_under_img">
                <img src="<?php echo e(custom_asset('front_assets/img/Computer-Course-Digital-Marketing-Course-Coding-Classes.jpg')); ?>" alt="img">
                </div>
            </div>
            <div class="col-md-4 mb-4">
                <div class="pills_under_img">
                <img src="<?php echo e(custom_asset('front_assets/img/Book-My-Ticket-–-Book-My-Ticket.jpg')); ?>" alt="img">
                </div>
            </div>
            <div class="col-md-4 mb-4">
                <div class="pills_under_img">
                <img src="<?php echo e(custom_asset('front_assets/img/Smartcare-travel.jpg')); ?>" alt="img">
                </div>
            </div>
            <div class="col-md-4 mb-4">
                <div class="pills_under_img">
                <img src="<?php echo e(custom_asset('front_assets/img/Gynaecologist-Near-Me.jpg')); ?>" alt="img">
                </div>
            </div>
        </div>
    </div>
  ...
  <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
    <div class="row">
        <div class="col-md-4 mb-4">
            <div class="pills_under_img">
            <img src="<?php echo e(custom_asset('front_assets/img/seo_service_tab_2.png')); ?>" alt="img">
        ...
        <div class="col-md-4 mb-4">
            <div class="pills_under_img">
            <img src="<?php echo e(custom_asset('front_assets/img/seo_service_tab_3.png')); ?>" alt="img">
  ...
  <div class="tab-pane fade" id="pills-service" role="tabpanel" aria-labelledby="pills-service-tab">   <div class="row">
    <div class="col-md-4 mb-4">
        <div class="pills_under_img">
        <img src="<?php echo e(custom_asset('front_assets/img/ppc_srvice_tab_1.png')); ?>" alt="img">
        </div>
    </div>

    <div class="col-md-4 mb-4">
        <div class="pills_under_img">
        <img src="<?php echo e(custom_asset('front_assets/img/ppc_srvice_tab_2.png')); ?>" alt="img">
        </div>
    </div>

    <div class="col-md-4 mb-4">
        <div class="pills_under_img">
        <img src="<?php echo e(custom_asset('front_assets/img/ppc_srvice_tab_3.png')); ?>" alt="img">
        </div>
    </div>

    <div class="col-md-4 mb-4">
        <div class="pills_under_img">
        <img src="<?php echo e(custom_asset('front_assets/img/ppc_srvice_tab_4.png')); ?>" alt="img">
        </div>
    </div>

    <div class="col-md-4 mb-4">
        <div class="pills_under_img">
        <img src="<?php echo e(custom_asset('front_assets/img/ppc_srvice_tab_5.png')); ?>" alt="img">
        </div>
    </div>    <div class="col-md-4 mb-4">
        <div class="pills_under_img">
        <img src="<?php echo e(custom_asset('front_assets/img/ppc_srvice_tab_6.png')); ?>" alt="img">
        </div>
    </div>
    </div>
</div>
<div class="tab-pane fade" id="pills-smo" role="tabpanel" aria-labelledby="pills-smo-tab">   <div class="row">
    <div class="col-md-4 mb-4">
        <div class="pills_under_img">
        <img src="<?php echo e(custom_asset('front_assets/img/Telecom-1.png')); ?>" alt="img">
    ...
    <div class="col-md-4 mb-4">
        <div class="pills_under_img">
        <img src="<?php echo e(custom_asset('front_assets/img/telecom-2.png')); ?>" alt="img">
        </div>
    </div>
...
<section class="feature_main_section padding">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-6">
                <div class="img_feature">
                    <img src="<?php echo e(custom_asset('front_assets/img/skills.webp')); ?>" alt="">
                </div>
            </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="main_laginator">
                    <img src="<?php echo e(custom_asset('front_assets/img/video_laginator_we.png')); ?>" alt="">
                </div>
                </div>
                <div class="col-md-6">
                    <div class="laginator_main_travel">
                        <div class="under_ycc">
                            <div class="lion_img">
                                <img src="<?php echo e(custom_asset('front_assets/img/lion_design_main.png')); ?>" alt="">
                            </div>
                            <div class="content">
...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <form action="<?php echo e(route('homelanding.store')); ?>" method="POST">
                    <div class="btn_pink">
...
<?php echo $__env->make('layouts.front.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\rahul\resources\views/frontend/seodigitalpage.blade.php ENDPATH**/ ?>