  ...
  <main class="page-content">
    ...
    <div class="card-body">
      ...
      <div class="col-12 col-lg-8 d-flex">
        <div class="card border shadow-none w-100">
        <div class="card-body">
          <form id="bulk-delete-form" method="POST" action="<?php echo e(route('blog_category.bulk-delete')); ?>">
          <?php echo csrf_field(); ?>
          ...
          <tr>
          <td><input type="checkbox" class="row-checkbox" data-id="<?php echo e($categorie->id); ?>"></td>
          <td><?php echo e($key + 1); ?></td>
          <td><?php echo e($categorie->category_name); ?></td>
          <td><?php echo e($categorie->slug); ?></td>
          <td>
          <div class="d-flex align-items-center gap-3 fs-6">
          <a href="<?php echo e(route('blog-category.edit', $categorie->id)); ?>" class="text-warning"
          ...
          <button type="button"
            ...
            data-url="<?php echo e(route('blog-category.destroy', $categorie->id)); ?>"><i
  ...
  <script>
    ...
    bulkDeleteBtn.addEventListener('click', function (event) {
      ...
      if (result.isConfirmed) {
        ...
        fetch("<?php echo e(route('blog_category.bulk-delete')); ?>", {
        method: 'POST',
        headers: {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.new-admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\DigirushNew\resources\views/admin/blog/category/index.blade.php ENDPATH**/ ?>