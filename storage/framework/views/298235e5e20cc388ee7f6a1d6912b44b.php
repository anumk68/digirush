<header class="header-wrapper main_section_new">
    <div class="phone_top_header">
        <div class="container">
            <div class="number">
                <a href="tel:+91 99159 54999"><i class="fa-solid fa-phone"></i>+91 99159 54999</a>
                <a href="mailto:support@digirushsolutions.com"><i
                        class="fa-solid fa-envelope"></i>support@digirushsolutions.com</a>
                <div class="btn-sec-headr">
                    <ul class="number_box fjhgf">
                        <li><a href="https://www.facebook.com/DigiRushSolutionLLP" bis_skin_checked="1"><i
                                    class="fa-brands fa-square-facebook"></i></a></li>
                        <li><a href="https://in.linkedin.com/company/digirushsolutions" bis_skin_checked="1"><i
                                    class="fa-brands fa-linkedin"></i></a></li>
                        <li><a href="https://x.com/i/flow/login?redirect_after_login=%2FDigirush_"
                                bis_skin_checked="1"><i class="fa-brands fa-twitter"></i></a></li>
                        <li><a href="https://www.instagram.com/digirushsolutions/" bis_skin_checked="1"><i
                                    class="fa-brands fa-instagram"></i></a></li>
                        <li><a href="https://www.youtube.com/@digirushsolutions" bis_skin_checked="1"><i
                ...
                <div class="topbar-left topbar-right">
                    <ul class="number_box">
                        ...
                        <li><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                            ...
                            </svg></span><a href="tel:+1 858-888-9215">+1 858-888-9215</a></li>
                        <li><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                id="Layer_1" x="0px" y="0px" viewBox="0 0 55.2 38.4"
                                style="enable-background:new 0 0 55.2 38.4" xml:space="preserve">
                                <style type="text/css">
                        ...
                        <li class="email_icon"><i class="fa-solid fa-envelope "></i><a
                                href="mailto:support@digirushsolutions.com">support@digirushsolutions.com</a></li>
                    </ul>
    ...
    <div class="navigation-wrapper">
        <div class="container">
            <div class="navigation-inner">
                <div class="site-logo">
                    <a href="<?php echo e(route('home')); ?>"><img src="<?php echo e(custom_asset('front_assets/img/edit_new_logo.png')); ?>"
                ...
                <nav class="navigation-menu">
                    <ul class="main-menu">
                        ...
                        <li><a href="<?php echo e(route('case_studies')); ?>">Case Studies</a></li>
                        <!-- <li><a href="<?php echo e(route('digital_marketing')); ?>">Digital Marketing</a>
                            <ul>
                                <li>
                                    <a href="<?php echo e(route('seo_company')); ?>">SEO Services</a>
                                    <ul>
                                        <li><a href="<?php echo e(route('local_seo_company')); ?>">Local SEO</a></li>
                                        <li><a href="<?php echo e(route('shopify_seo')); ?>">eCommerce SEO</a></li>
                                        <li><a href="<?php echo e(route('social_media_marketing')); ?>">Social Media Marketing</a>
                                        </li>
                                        </li>
                                </ul>
                        </li>

                                <li><a href="<?php echo e(route('ppc_expert')); ?>">PPC Service</a></li>
                                <li><a href="<?php echo e(route('content_management')); ?>">Content Management Marketing</a></li>
                            </ul>
                        </li>
                  
                        <li><a href="<?php echo e(route('web_services')); ?>">Web Services</a>
                            <ul>
                                <li><a href="<?php echo e(route('web_development')); ?>">Web Development</a>
                                </li>
                                <li><a href="<?php echo e(route('web_designing')); ?>">Web Design</a>
                        ...
                        <li class="dropdown">
                            <div class="dropdown-toggle">
                                <a href="#" class="dropdown-link">Services <span><i
                            ...
                            <div class="dropdown-menu">
                                <div class="dropdown-columns">
                                    ...
                                    <a href="<?php echo e(route('local-seo')); ?>">Local SEO</a>
                                    <a href="">E-commerce SEO </a>
                                    <a href="<?php echo e(route('mobile-seo')); ?>">Mobile SEO </a>
                                    <a href="">PPC Services </a>
                                    <a href="<?php echo e(route('content-marketing')); ?>">Content Marketing</a>
                                </div> -->
                                    <div class="column">
                                        <h4>Digital Marketing</h4>

                                        <div class="submenu-wrapper">
                                            <a href="<?php echo e(route('seo_company')); ?>" class="has-submenu">
                                                <img src="<?php echo e(custom_asset('front_assets/img/seo-services-icon.png')); ?>"
                                                    alt="digirusholution">
                                                SEO Services
                                                <span class="arrow"><i class="fas fa-chevron-right"></i></span>
                                            </a>
                                            <div class="submenu">
                                                <a href="<?php echo e(route('local_seo_company')); ?>"> <img
                                                        src="<?php echo e(custom_asset('front_assets/img/local-seo.png')); ?>"
                                                        alt="digirusholution"> Local SEO</a>
                                                <a href="<?php echo e(route('shopify_seo')); ?>"> <img
                                                        src="<?php echo e(custom_asset('front_assets/img/ecommerce-seo.png')); ?>"
                                                        alt="digirusholution"> E-commerce SEO</a>
                                                <!-- <a href="<?php echo e(route('mobile-seo')); ?>"> <img
                                                        src="<?php echo e(custom_asset('front_assets/img/seo-services-icon.png')); ?>"
                                                        alt="digirusholution"> Mobile SEO</a> -->
                                            </div>
                                        </div>
                                        <?php $__currentLoopData = $header_data->where('title', 'Digital Marketing')->where('type', 'header')->where('status', '1')->unique(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $header): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <a href="<?php echo e(route('dynamic_page', ['slugs' => $header->slug])); ?>"><img
                                                    src="<?php echo e(custom_asset($header->icon)); ?>" alt="digirusholution">
                                                <?php echo e($header->header); ?>

                                            </a>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <a href="<?php echo e(route('ppc_expert')); ?>"> <img
                                                src="<?php echo e(custom_asset('front_assets/img/link.png')); ?>"
                                                alt="digirusholution"> PPC Services</a>
                                        <a href="<?php echo e(route('social_media_marketing')); ?>"> <img
                                                src="<?php echo e(custom_asset('front_assets/img/social-media-marketing-icon.png')); ?>"
                                                alt="digirusholution"> Social Media Marketing</a>


                                        <a href="<?php echo e(route('content_management')); ?>"> <img
                                                src="<?php echo e(custom_asset('front_assets/img/content-marketing.png')); ?>"
                                                alt="digirusholution"> Content Marketing</a>
                                        <a href="<?php echo e(route('digital_marketing')); ?>"> <img
                                                src="<?php echo e(custom_asset('front_assets/img/digital marketing icon.svg')); ?>"
                                                alt="digirusholution"> Digital Marketing</a>
                                    </div>
                                    <div class="column">
                                        ...
                                        <div class="submenu-wrapper">
                                            <a href="" class="has-submenu">
                                                <img src="<?php echo e(custom_asset('front_assets/img/app-development.png')); ?>"
                                                    alt="digirusholution">
                                                App Development
                                                <span class="arrow"><i class="fas fa-chevron-right"></i></span>
                                            </a>
                                            <div class="submenu">
                                                <?php $__currentLoopData = $header_data->where('title', 'App Development')->where('type', 'header')->where('status', '1')->unique(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $header): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <a href="<?php echo e(route('dynamic_page', ['slugs' => $header->slug])); ?>"><img
                                                            src="<?php echo e(custom_asset($header->icon)); ?>" alt="digirusholution">
                                                        <?php echo e($header->header); ?>
                                                ...
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                <!-- <a href="#"> <img src="<?php echo e(custom_asset('front_assets/img/software-development.png')); ?>" alt="digirusholution"> IOS Development</a> -->
                                            </div>
                                        </div>
                                        <a href="<?php echo e(route('web_development')); ?>"><img
                                                src="<?php echo e(custom_asset('front_assets/img/web-development-icon.png')); ?>"
                                                alt="digirusholution"> Web Development</a>
                                        <?php $__currentLoopData = $header_data->where('title', 'Web Development')->where('type', 'header')->where('status', '1')->unique(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $header): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <a href="<?php echo e(route('dynamic_page', ['slugs' => $header->slug])); ?>"><img
                                                    src="<?php echo e(custom_asset($header->icon)); ?>" alt="digirusholution">
                                                <?php echo e($header->header); ?>
                                    ...
                                    <div class="column">
                                        <h4>Web Design</h4>
                                        <a href="<?php echo e(route('web_designing')); ?>"><img
                                                src="<?php echo e(custom_asset('front_assets/img/web-design-icon.png')); ?>"
                                                alt="digirusholution">Web Design</a>
                                        <?php $__currentLoopData = $header_data->where('title', 'Web Design')->where('type', 'header')->where('status', '1')->unique(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $header): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <a href="<?php echo e(route('dynamic_page', ['slugs' => $header->slug])); ?>"><img
                                                    src="<?php echo e(custom_asset($header->icon)); ?>" alt="digirusholution">
                                                <?php echo e($header->header); ?>
                                    ...
                                    <div class="column">
                                        <h4>Branding</h4>
                                        <?php $__currentLoopData = $header_data->where('title', 'Branding')->where('type', 'header')->where('status', '1')->unique(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $header): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <a href="<?php echo e(route('dynamic_page', ['slugs' => $header->slug])); ?>"><img
                                                    src="<?php echo e(custom_asset($header->icon)); ?>" alt="digirusholution">
                                                <?php echo e($header->header); ?>
                        ...
                        <li><a href="<?php echo e(route('blog.show')); ?>">Blog</a></li>
                ...
                <div class="header-right">
                    <ul>
                        <li class="d-none d-lg-block">
                            <?php if(Route::currentRouteName() !== 'hire-developers'): ?>
                                <a href="<?php echo e(route('hire-developers')); ?>" class="default-btn">Hire Us Now</a>
                            <?php endif; ?>
                        </li>
...
<section class="button_fixed">
    <div class="container-fluid g-0">
        <div class="btn_main_contact_us">
            <a href="javascript:void(0);" class="team-btn" id="contactBtn">Contact Us</a>
            <div class="main_subscription_form" id="contactForm" style="display: none;">
                <div class="under_form_sestion">
                    <span class="close-form" id="closeForm">&times;</span> <!-- Close button -->
 ...
 ">
                    ...
                    <form action="<?php echo e(route('submit_home_form')); ?>" method="POST" id="myform1">
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <select name="countryCode" id="">
                                        <option data-countryCode="IN" value="91" <?php echo e(old('countryCode') == '91' ? 'selected' : ''); ?>>Ind (+91)</option>
                                        <option data-countryCode="UK" value="44" <?php echo e(old('countryCode') == '44' ? 'selected' : ''); ?>>UK (+44)</option>
                                        <option data-countryCode="US" value="1" <?php echo e(old('countryCode') == '1' ? 'selected' : ''); ?>>US (+1)</option>
                                    </select>
                                </div>
                                <input type="text" id="phone" name="number" minlength="10" maxlength="10"
                                    class="form-control" value="<?php echo e(old('number')); ?>" required>
                            </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-field">
                            <select name="services" id="services">
                                ...
                                <option value="Social Media Marketing" <?php echo e(old('services') == 'Social Media Marketing' ? 'selected' : ''); ?>>
                                    Social Media Marketing
                                </option>
                                <option value="Web Hosting" <?php echo e(old('services') == 'Web Hosting' ? 'selected' : ''); ?>>
                                    Web Hosting
                                </option>
                                <option value="Web Design & Development" <?php echo e(old('services') == 'Web Design & Development' ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-field" id="otp-group" style="display: none;">
                            <input type="text" name="otp" placeholder="Enter OTP" class="form-control" minlength="6"
                                maxlength="6" pattern="\d{6}" disabled>
...
<div class="fixed_button_call">
    <div class="call-now-wrapper">
        <div class="call-now-tab">Call Now</div>
        <div class="call-now-box">
            <div class="call-now-item">
            ...
            <div class="call-now-item">
                ...
                <a href="tel:+91 99159 54999">+1 858-888-9215</a>
            </div>
            <div class="call-now-item">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="Layer_1" x="0px"
                    y="0px" viewBox="0 0 55.2 38.4" style="enable-background:new 0 0 55.2 38.4" xml:space="preserve">
                ...
                <a href="tel:+91 99159 54999">+44 1865 60 0823</a>
            </div>
        </div>
    </div>
...
<section class="whatsap_Sec">
    <div id="container">
        <div id="whatsapp">
            ...
            <a href="https://api.whatsapp.com/send?phone=+91 99159 54999&amp;text= Help For Loan Suvidha"
                target="_blank">
                <svg width="80" height="80" xmlns="http://www.w3.org/2000/svg" xmlns:svg="http://www.w3.org/2000/svg">
                    <g class="layer">
                        <circle cx="40" cy="40" fill="#fff" id="svg_1" r="30" stroke="#000000" stroke-width="0">
                        </circle>
                        <path
                            ...
                            fill="currentColor" id="svg_2"></path>
                    </g>
                </svg>
            </a>
        </div>
    </div>
</section><?php /**PATH C:\xampp\htdocs\DigirushNew\resources\views/layouts/front/header.blade.php ENDPATH**/ ?>