...
<head>
    ...
    <title><?php echo e($data->meta_title ?? 'Digi Rush Solutions | A Complete Web Solutions Agency in India'); ?></title>
    <meta name="description"
        content="<?php echo trim(html_entity_decode(strip_tags($data->meta_description ?? 'Digi Rush Solutions offers expert digital marketing, web design, and development services for online success with customized solutions.'))); ?>">
    <meta name="keywords" content="<?php echo e($data->meta_keyword ?? 'default'); ?>">

    <!-- <title><?php echo e($metatitle ?? 'Digi Rush Solutions | A Complete Web Solutions Agency in India'); ?></title>
    <meta name="description"
        content="<?php echo e($metaDescription ?? 'Digi Rush Solutions offers expert digital marketing, web design, and development services for online success with customized solutions.'); ?>">
    <meta name="keywords" content="<?php echo e($metaKeywords ?? 'default'); ?>"> -->
    ...
    <meta property="og:title"
        content="<?php echo e($metatitle ?? 'Digi Rush Solutions | A Complete Web Solutions Agency in India'); ?>">
    <meta property="og:description"
        content="<?php echo e($metaDescription ?? 'Digi Rush Solutions offers expert digital marketing, web design, and development services for online success with customized solutions.'); ?>">
    <meta property="og:image" content="<?php echo e($ogImage ?? asset('public/front_assets/img/F-Logo.png')); ?>">
    <meta property="og:url" content="<?php echo $__env->yieldContent('og_url', request()->url()); ?>">
    <meta property="og:type" content="website">

    
    <link rel="canonical" href="<?php echo e(url()->current()); ?>">
    <link rel="shortcut icon" href="<?php echo e(asset('public/front_assets/img/DigiRush_Solution.png')); ?>" type="image/x-icon">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('public/front_assets/customize.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('public/front_assets/css/bootstrap.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('public/front_assets/css/animate.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('public/front_assets/css/line-awesome.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('public/front_assets/css/redias-icons.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('public/front_assets/css/odometer.min.css')); ?>">
    <!-- <link rel="stylesheet" href="<?php echo e(asset('public/front_assets/css/venobox.min.css')); ?>"> -->
    <link rel="stylesheet" href="<?php echo e(asset('public/front_assets/css/keyframe-animation.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('public/front_assets/css/swiper.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('public/front_assets/css/main.css')); ?>">
    <?php echo $__env->yieldContent('stylesheets'); ?>

    
    <?php if(!in_array(Request::url(), [route('home.landing'), route('seo-digitalservices')])): ?>
    ...
    <?php echo $__env->yieldContent('meta_robots'); ?>
    <?php echo $__env->yieldContent('heads'); ?>
    <?php echo $__env->yieldContent('headTag'); ?>
...
<body class="header-2">
    ...
    <?php if(Request::url() != route('home.landing') && Request::url() != route('seo-digitalservices')): ?>
    ...
    <script src="<?php echo e(asset('public/front_assets/js/vendor/modernizr-2.8.3-respond-1.4.2.min.js')); ?>"></script>
    <script src="<?php echo e(asset('public/front_assets/js/vendor/bootstrap.min.js')); ?>"></script>
    <script src="<?php echo e(asset('public/front_assets/js/vendor/popper.min.js')); ?>"></script>
    <script src="<?php echo e(asset('public/front_assets/js/vendor/odometer.min.js')); ?>"></script>
    <script src="<?php echo e(asset('public/front_assets/js/vendor/waypoints.min.js')); ?>"></script>
    <!-- <script src="<?php echo e(asset('public/front_assets/js/vendor/venobox.min.js')); ?>" ></script> -->
    <script src="<?php echo e(asset('public/front_assets/js/vendor/swiper.min.js')); ?>"></script>
    <script src="<?php echo e(asset('public/front_assets/js/vendor/smooth-scroll.js')); ?>"></script>

    <script src="<?php echo e(asset('public/front_assets/js/vendor/wow.min.js')); ?>"></script>
    <script src="<?php echo e(asset('public/front_assets/js/quote.js')); ?>"></script>
    ...
    <script>
        document.getElementById('myForm').addEventListener('submit', async function (e) {
            ...
            try {
                const response = await fetch("<?php echo e(route('submit_home_form')); ?>", {
                    method: "POST",
                    headers: {
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            async function verifyPhoneNumber() {
                ...
                try {
                    ...
                    const url = `http://apilayer.net/api/validate?access_key=4ff091d83e999f191befe83856b18cd4&number=${encodeURIComponent(fullNumber)}&format=1`;
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            async function verifyPhoneNumber() {
                ...
                try {
                    ...
                    const url = `https://apilayer.net/api/validate?access_key=4ff091d83e999f191befe83856b18cd4&number=${encodeURIComponent(fullNumber)}&format=1`;
                    const res = await fetch(url);
                    const data = await res.json();
                    if (data.valid) {
...
</html><?php /**PATH C:\xampp\htdocs\digirush_coderemove\resources\views/layouts/front/app.blade.php ENDPATH**/ ?>