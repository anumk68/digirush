                    ...
                    <table style="width: 100%;">
                        <tr>
                            <td>
                                ...
                                <h2 style="font-weight: 200; font-size: 20px; margin: 20px 0; color: #333333;">Name: <?php echo e($data['name']); ?> </h2>
                                <h2 style="font-weight: 200; font-size: 20px; margin: 20px 0; color: #333333;">Email: <?php echo e($data['email_person']); ?> </h2>
                                <h2 style="font-weight: 200; font-size: 20px; margin: 20px 0; color: #333333;">Phone: <?php echo e($data['phone']); ?> </h2>
                                <h2 style="font-weight: 200; font-size: 20px; margin: 20px 0; color: #333333;">Service: <?php echo e($data['services']); ?> </h2>
                                <h2 style="font-weight: 200; font-size: 20px; margin: 20px 0; color: #333333;">City: <?php echo e($data['city']); ?> </h2>
...
<?php /**PATH C:\xampp\htdocs\DigirushNew\resources\views/mail/contact_us.blade.php ENDPATH**/ ?>