<?php $__env->startSection('content'); ?>
    <section class="page-header page-header-secnd"
        style="background-image: url(<?php echo e(custom_asset('front_assets/img/about_banner_.jpg')); ?>);">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 sm-padding wow fade-in-left" data-wow-delay="200ms"
                    ...
                    <div class="about-thumbs">
                        <img src="<?php echo e(custom_asset('front_assets/img/new_img_main.jpg')); ?>"
                ...
                <div class="col-lg-6 sm-padding">
                    ...
                    <div class="about-content">
                        <p>Digi Rush Solutions is the best and top-rated IT solutions agency in India, offering a
                            ...
                            development company in India and the <a href="<?php echo e(route('seo_company')); ?>">best SEO agency in
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 mb-3">
                    <div class="vision_under">
                        <div class="icon_img abt_icon_img_hd">
                            <img src="<?php echo e(custom_asset('front_assets/img/mission _immg.png')); ?>"
                ...
                <div class="col-md-4 mb-3">
                    <div class="vision_under">
                        <div class="icon_img abt_icon_img_hd">
                            <img src="<?php echo e(custom_asset('front_assets/img/vision _immg.png')); ?>"
                ...
                <div class="col-md-4 mb-3">
                    <div class="vision_under">
                        <div class="icon_img abt_icon_img_hd">
                            <img src="<?php echo e(custom_asset('front_assets/img/value_immg.png')); ?>"
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-8 sm-padding">
                    <div class="section-heading mb-40">
                        ...
                        <a href="<?php echo e(route('contact')); ?>" class="default-btn">Get In Touch</a>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.front.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\digirush_coderemove\resources\views/frontend/about.blade.php ENDPATH**/ ?>