                  ...
                  <div class="card-body">
                      <div class="d-flex align-items-center">
                          <div>
                              ...
                              <?php
                                $blogs = App\Models\Blog::where('category_id', '!=', '34')->count();
                              ?>
                              <h4 class="my-1"><?php echo e($blogs); ?></h4>
               ...
               <div class="col">
                  <div class="card radius-10">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div>
                                <p class="mb-0 text-secondary">Contact Enquiry</p>
                                <?php
               ...
               <div class="col">
                <div class="card radius-10">
                  <div class="card-body">
                      <div class="d-flex align-items-center">
                          <div>
                              <p class="mb-0 text-secondary">SEO Enquiry</p>
...
<?php echo $__env->make('layouts.new-admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\DigirushNew\resources\views/admin/new-dashboard.blade.php ENDPATH**/ ?>