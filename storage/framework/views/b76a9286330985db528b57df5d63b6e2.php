<?php $__env->startSection("content"); ?>
    <section class="page-header page-header-secnd" style="background-image: url(<?php echo e(custom_asset('front_assets/img/blog_banner.png')); ?>);">
                                        ...
                                        <div class="col-lg-4 col-md-6 col-12 padding-15">
                                            <div class="post-card">
                                                <div class="post-thumb">
                                                    <a href="<?php echo e(url('blogs').'/'.$blog->slug); ?>" class="hover"><img src="<?php echo e(custom_asset($blog->banner)); ?>" class="img-fluid img_bloger"></a>
                                                ...
                                                <div class="post-content-wrap">
                                                    ...
                                                    <div class="post-content main_post_blog_cntnt">
                                                        <!-- <h3><a href="<?php echo e(url('blogs').'/'.$blog->slug); ?>" class="hover"><?php echo e($blog->title); ?></a></h3> -->
                                                        <h3><a href="<?php echo e(url('blogs').'/'.$blog->slug); ?>" class="hover">   <?php echo e(strlen($blog->title) > 80 ? Str::limit($blog->title, 80) : $blog->title); ?></a></h3>
                                                        <p><a href="<?php echo e(url('blogs').'/'.$blog->slug); ?>" class="hover"><?php echo e(substr($blog->short_description,0,80)); ?> ... </a></p> 
                                                    </div> 
                                                </div>
                                            </div>                                  
                                        </div>
...
<?php echo $__env->make("layouts.front.app", array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\rahul\resources\views/frontend/blogs/index.blade.php ENDPATH**/ ?>