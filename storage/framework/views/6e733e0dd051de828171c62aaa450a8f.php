<?php $__env->startSection('content'); ?>
    ...
    <section class="page-header page-header-secnd" style="background-image: url(<?php echo e(custom_asset('front_assets/img/content_banner.png')); ?>);">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 sm-padding">
                    ...
                    <div class="about-content">
                        ...
                        <p>As a leading <a href="<?php echo e(route('content_management')); ?>">Content Marketing Agency in India,</a> we understand that content marketing is the process of mapping out ideas and developing content that is aligned with SEO guidelines and works with the goals of the business. It is for this reason that <a href="https://digirushsolutions.com/blogs/dont-get-left-behind-how-content-updating-can-keep-you-ahead-in-2023-2">content writing</a> has grown so much in prominence over the last few years.</p>
                ...
                <div class="col-lg-6 sm-padding">
                    <div class="about-thumb">
                        <img src="<?php echo e(custom_asset('front_assets/img/medi_global_mainn.jpg')); ?>" alt="content marketing services">
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.front.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\DigirushNew\resources\views/frontend/content_management.blade.php ENDPATH**/ ?>