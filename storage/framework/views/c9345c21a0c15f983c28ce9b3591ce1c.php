...
<section class="page-header page-header-secnd" style="background-image: url(<?php echo e(custom_asset('front_assets/img/web_service_bannner_provide.png')); ?>);">
      ...
      <div class="row align-items-center">
         <div class="col-lg-6 sm-padding">
            ...
            <div class="about-content">
               ...
               <p>As one of the best web service agencies and <a href="<?php echo e(route('web_services')); ?>">best web service providers,</a> we leverage standardized protocols and formats, making it easier for diverse applications to work together effectively.</p>
               <a href="contact.php" class="default-btn">GET STARTED</a>
            </div>
         </div>
         <div class="col-lg-6 sm-padding">
            <div class="about-thumb">
               <img src="<?php echo e(custom_asset('front_assets/img/webserv.jpg')); ?>" alt="best web service providers">
            </div>
         </div>
      </div>
   </div>
...
<?php echo $__env->make('layouts.front.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\DigirushNew\resources\views/frontend/web_services.blade.php ENDPATH**/ ?>