<?php $__env->startSection('content'); ?>
  ...
  <section class="banner-slider owl-carousel owl-theme">
    ...
    <div class="d-flex justify-content-center flex-wrap mt-4 animate__animated animate__fadeInUp animate__delay-3s">
      <a href="<?php echo e(route('about')); ?>" class="btn btn-custom btn-read">≡ About Digirush</a>
      <a href="<?php echo e(route('contact')); ?>" class="btn btn-custom btn-contact"><i class="fas fa-phone"></i>Contact Us</a>
    </div>
  ...
  <!-- 
     <section class="hero-section page-header" style="background-image: url('public/front_assets/img/home_banner_slide_1.webp' );">
      ...
      <div class="hero-content ">
       ...
       <div class="img_logo_pilot"><a href="https://g.co/kgs/bD26grj"><img src="<?php echo e(custom_asset('front_assets/img/google- (1).webp')); ?>" alt="DigiRush"loading="lazy"></a> </div>
       <div class="img_logo_pilot"><a href="https://www.upwork.com/agencies/1631222952270098432/"><img src="<?php echo e(custom_asset('front_assets/img/Upwork-logo.webp')); ?>" alt="DigiRush"loading="lazy"></a></div>
       <div class="img_logo_pilot"> <a href="#"><img src="<?php echo e(custom_asset('front_assets/img/freelancer.webp')); ?>" alt="DigiRush" loading="lazy"></a></div>
       <div class="img_logo_pilot"> <a href="https://www.trustpilot.com/review/digirushsolutions.com 
      "><img src="<?php echo e(custom_asset('front_assets/img/visualhunter.webp')); ?>" alt="DigiRush" loading="lazy"></a></div>
      </div>
      ...
      <div class="brands-circle">
       ...
       <div class="center-icon"><img src="<?php echo e(custom_asset('front_assets/img/DigiRush_Solution.webp')); ?>" alt="DigiRush"loading="lazy">
       </div>
       <div class="outer-icon">
       <i class=""><a href="<?php echo e(route('web_development')); ?>"><img src="<?php echo e(custom_asset('front_assets/icon/app-development.webp')); ?>" alt="app-development" loading="lazy"></a></i>
       <i class=""><a href="<?php echo e(route('seo_company')); ?>"><img src="<?php echo e(custom_asset('front_assets/icon/seo.webp')); ?>" alt="seo" loading="lazy"></a></i>
       <i class=""><a href="<?php echo e(route('ppc_expert')); ?>"><img src="<?php echo e(custom_asset('front_assets/icon/pay-per-click.webp')); ?>" alt="pay-per-click" loading="lazy"></a></i>
       <i class=""><a href="<?php echo e(route('content_management')); ?>"><img src="<?php echo e(custom_asset('front_assets/icon/cms.webp')); ?>" alt="cms" loading="lazy"></i>
       </div>
      </div>
      </div>
      </div>
  ...
  <section class="our_partners padding">
    ...
    <div class="row justify-content-center">
      ...
      <img src="<?php echo e(custom_asset('front_assets/img/aws_amazon.png')); ?>" alt="digital_service" loading="lazy">
      </div>


      <div class="patners_img">
      <img src="<?php echo e(custom_asset('front_assets/img/freelancer_logo.png')); ?>" alt="digital_service" loading="lazy">
      </div>


      <div class="patners_img">
      <img src="<?php echo e(custom_asset('front_assets/img/google_my_business.png')); ?>" alt="digital_service" loading="lazy">
      </div>


      <div class="patners_img">
      <img src="<?php echo e(custom_asset('front_assets/img/trustpilot_logo.png')); ?>" alt="digital_service" loading="lazy">
      </div>


      <div class="patners_img">
      <img src="<?php echo e(custom_asset('front_assets/img/upwork_logo.png')); ?>" alt="digital_service" loading="lazy">
      </div>


      <div class="patners_img">
      <img src="<?php echo e(custom_asset('front_assets/img/yellow_pages_.png')); ?>" alt="digital_service" loading="lazy">
      </div>

      <div class="patners_img">
      <img src="<?php echo e(custom_asset('front_assets/img/yelp_logo.png')); ?>" alt="digital_service" loading="lazy">
      </div>
    </div>
    </div>
  </section>
      ...
      <div class="swiper-wrapper">
        ...
        <div class="main_promo_delay">
          ...
          <div class="promo-head">
            <div class="promo-icon"><img src="<?php echo e(custom_asset('front_assets/img/digi_mar_src.png')); ?>"
          ...
          <div class="promo-content">
            ...
            growth. </p>
            <a href="<?php echo e(route('digital_marketing')); ?>" class="read-more">Explore Services <span><i
        ...
        <div class="main_promo_delay">
          <div class="promo-item">
          <div class="promo-head">
            <div class="promo-icon"> <img src="<?php echo e(custom_asset('front_assets/img/digital_service_2.webp')); ?>"
          ...
          <div class="promo-content">
            ...
            for your business.</p>
            <a href="<?php echo e(route('ppc_expert')); ?>" class="read-more">Explore Services <span><i
              class="las la-long-arrow-alt-right"></i></span></a>
          </div>
          </div>
        </div>
        ...
        <div class="main_promo_delay">
          <div class="promo-item">
          <div class="promo-head">
            <div class="promo-icon"> <img src="<?php echo e(custom_asset('front_assets/img/digital_service_3.webp')); ?>"
          ...
          <div class="promo-content">
            ...
            SEO services.</p>
            <a href="<?php echo e(route('seo_company')); ?>" class="read-more">Explore Services <span><i
              class="las la-long-arrow-alt-right"></i></span></a>
          </div>
          </div>
        </div>
        ...
        <div class="main_promo_delay">
          <div class="promo-item">
          <div class="promo-head">
            <div class="promo-icon"> <img src="<?php echo e(custom_asset('front_assets/img/digital_service_4.webp')); ?>"
          ...
          <div class="promo-content">
            ...
            <a href="<?php echo e(route('social_media_marketing')); ?>" class="read-more">Explore Services <span><i
              class="las la-long-arrow-alt-right"></i></span></a>
          </div>
          </div>
        </div>
        ...
        <div class="main_promo_delay">
          <div class="promo-item">
          <div class="promo-head">
            <div class="promo-icon"> <img src="<?php echo e(custom_asset('front_assets/img/digital_service_5.webp')); ?>"
          ...
          <div class="promo-content">
            ...
            design services.</p>
            <a href="<?php echo e(route('web_designing')); ?>" class="read-more">Explore Services <span><i
              class="las la-long-arrow-alt-right"></i></span></a>
          </div>
          </div>
        </div>
        ...
        <div class="main_promo_delay">
          <div class="promo-item">
          <div class="promo-head">
            <div class="promo-icon"> <img src="<?php echo e(custom_asset('front_assets/img/digital_service_6.webp')); ?>"
          ...
          <div class="promo-content">
            ...
            code at a time. </p>
            <a href="<?php echo e(route('web_development')); ?>" class="read-more">Explore Services <span><i
              class="las la-long-arrow-alt-right"></i></span></a>
          </div>
          </div>
        </div>
  ...
  <section class="about-section padding">
    ...
    <div class="row align-items-center">
      ...
      <div class="about-thumbs">
        <img src="<?php echo e(custom_asset('front_assets/img/new_img_main.webp')); ?>" alt="Project-img" loading="lazy">
      ...
      <div class="main_servicing_f">
        ...
        <p><a href="<?php echo e(route('home')); ?>">Digi Rush Solutions</a> is a full service digital agency specializing
        ...
        <p>As we are a <a href="<?php echo e(route('digital_marketing')); ?>">advertising agency in india,</a> we use
        ...
        <a href="<?php echo e(route('about')); ?>" class="default-btn">More About Us</a>
        </div>
      </div>
      </div>
    </div>
  ...
  <section class=" service-2 bg-dark padding service-section-respons">
    ...
    <div class="row">
      ...
      <div class="service-card">
        ...
        <div class="service-icon"> <img src="<?php echo e(custom_asset('front_assets/icon/content-strategy.webp')); ?>"
        ...
        <div class="button_main_service">
          <a href="<?php echo e(route('digital_marketing')); ?>" class="default-btn">Explore Services <span><i
            class="las la-long-arrow-alt-right"></i></span></a>
        </div>
        </div>
      </div>
      ...
      <div class="service-card">
        <div class="service-head">
        <div class="service-icon"> <img src="<?php echo e(custom_asset('front_assets/icon/pay-per-click-icoooo.webp')); ?>"
        ...
        <p>Pay Per Click (PPC) is a powerful advertising model where businesses pay only when users click on
          ...
          efficiently. </p>
        <div class="button_main_service">
          <a href="<?php echo e(route('ppc_expert')); ?>" class="default-btn">Explore Services <span><i
            class="las la-long-arrow-alt-right"></i></span></a>
        </div>
        </div>
      </div>
      ...
      <div class="service-card">
        <div class="service-head">
        <div class="service-icon"> <img src="<?php echo e(custom_asset('front_assets/icon/shopping-online-icoo.webp')); ?>"
        ...
        <p>Social Media Marketing (SMM) is vital for businesses, enhancing brand visibility, engaging target
          ...
          marketing efforts. </p>
        <div class="button_main_service">
          <a href="<?php echo e(route('social_media_marketing')); ?>" class="default-btn">Explore Services <span><i
            class="las la-long-arrow-alt-right"></i></span></a>
        </div>
        </div>
      </div>
      ...
      <div class="service-card">
        <div class="service-head">
        <div class="service-icon"> <img src="<?php echo e(custom_asset('front_assets/icon/seo.webp')); ?>" alt="seo"
          loading="lazy"></div>
        <h3>SEO</h3>
        </div>
        <div class="service-content">
        ...
        <div class="button_main_service">
          <a href="<?php echo e(route('seo_company')); ?>" class="default-btn">Explore Services <span><i
            class="las la-long-arrow-alt-right"></i></span></a>
        </div>
        </div>
      </div>
      ...
      <div class="service-card">
        ...
        <div class="service-icon">
          <img src="<?php echo e(custom_asset('front_assets/icon/app-development.webp')); ?>" alt="web-devlopment"
          loading="lazy">
        </div>
        ...
        <div class="button_main_service">
          <a href="<?php echo e(route('web_development')); ?>" class="default-btn">Explore Services <span><i
            class="las la-long-arrow-alt-right"></i></span></a>
        </div>
        </div>
      </div>
      ...
      <div class="service-card">
        <div class="service-head">
        <div class="service-icon"><img src="<?php echo e(custom_asset('front_assets/icon/programming.webp')); ?>"
        ...
        <div class="button_main_service">
          <a href="<?php echo e(route('web_designing')); ?>" class="default-btn">Explore Services <span><i
            class="las la-long-arrow-alt-right"></i></span></a>
        </div>
        </div>
      </div>
      ...
      <div class="service-card">
        <div class="service-head">
        <div class="service-icon">
          <img src="<?php echo e(custom_asset('front_assets/icon/cms.webp')); ?>" alt="cms" loading="lazy">
          </i>
        </div>
        ...
        <div class="button_main_service">
          <a href="<?php echo e(route('content_management')); ?>" class="default-btn">Explore Services <span><i
            class="las la-long-arrow-alt-right"></i></span></a>
        </div>
        </div>
      </div>
      ...
      <div class="service-card">
        <div class="service-head">
        <div class="service-icon">
          <img src="<?php echo e(custom_asset('front_assets/icon/optimizing.webp')); ?>" alt="web-maintenance" loading="lazy">
          </i>
        </div>
        ...
        <div class="button_main_service">
          <a href="<?php echo e(route('dynamic_page', 'website-maintenence-company')); ?>" class="default-btn">Explore Services
      ...
      <div class="service-card">
        <div class="service-head">
        <div class="service-icon"><img src="<?php echo e(custom_asset('front_assets/icon/cloud-server.webp')); ?>"
        ...
        <div class="button_main_service">
          <a href="<?php echo e(route('dynamic_page', 'graphic-design-services')); ?>" class="default-btn">Explore Services
          <span><i class="las la-long-arrow-alt-right"></i></span></a>
        </div>
        </div>
      </div>
  ...
  <section class="featured_logos">
    ...
    <div class="row justify-content-center mt-4">
      ...
      <div class="featured-badge bg-soft-pink">
        <img src="<?php echo e(custom_asset('front_assets/img/ei_logo.svg')); ?>" alt="hindustan times" loading="lazy">
      </div>
      </div>
      <div class="col-lg-2 col-md-3 col-sm-12">
      <div class="featured-badge bg-soft-yellow">
        <img src="<?php echo e(custom_asset('front_assets/img/tracxn-logo.svg')); ?>" alt="hindustan times" loading="lazy">
      </div>
      </div>
      <div class="col-lg-2 col-md-3 col-sm-12">
      <div class="featured-badge bg-soft-blue">
        <img src="<?php echo e(custom_asset('front_assets/img/superb_logo.png')); ?>" alt="hindustan times" loading="lazy">
      </div>
      </div>
      <div class="col-lg-2 col-md-3 col-sm-12">
      <div class="featured-badge bg-soft-yellow">
        <img src="<?php echo e(custom_asset('front_assets/img/ambition_box.png')); ?>" alt="hindustan times" loading="lazy">
      </div>
      </div>
  ...
  <section class="counter-section  counting_mainn bg-grey section-2 padding">
    ...
    <div class="row align-items-center">
      ...
      <div class="row">
        <div class="col-md-6">
        <div class="feature-img img-1"><img src="<?php echo e(custom_asset('front_assets/img/feature-2.webp')); ?>" alt="img"
          loading="lazy"></div>
        <div class="experience-item">
          <img src="<?php echo e(custom_asset('front_assets/img/award-symbol.webp')); ?>" alt="img" loading="lazy">
          <h3>10+ Years <br>Experience!</h3>
        </div>
        </div>
        <div class="col-md-6">
        <div class="feature-img img-2"><img src="<?php echo e(custom_asset('front_assets/img/feature-2_3.webp')); ?>" alt="img"
          loading="lazy"></div>
        </div>
      </div>
      </div>
  ...
  <section class="video-section">
    ...
    max-width: 148px;
     ">
        ...
        <form action="<?php echo e(route('quote.store')); ?>" method="POST" id="myform2">
          <?php echo csrf_field(); ?>
          <input type="hidden" name="form_id" value="form2">
          <div class="form-field">
          <input type="text" id="fname" name="fname" placeholder="Full Name" value="<?php echo e(old('fname')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
          ...
          <div class="form-field">
          <input type="text" id="city" name="city" placeholder="City" value="<?php echo e(old('city')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
          ...
          <select name="services" id="services">
            ...
            <option value="Digital Marketing (complete)" <?php echo e(old('services') == 'Digital Marketing (complete)' ? 'selected' : ''); ?>>
            Digital Marketing (complete)
            </option>
            <option value="Content Marketing & Management" <?php echo e(old('services') == 'Content Marketing & Management' ? 'selected' : ''); ?>>
            Content Marketing & Management
            </option>
            <option value="Keyword Research" <?php echo e(old('services') == 'Keyword Research' ? 'selected' : ''); ?>>
            Keyword Research
            </option>
            <option value="Pay Per Click" <?php echo e(old('services') == 'Pay Per Click' ? 'selected' : ''); ?>>
            Pay Per Click
            </option>
            <option value="Search Engine Optimization (SEO)" <?php echo e(old('services') == 'Search Engine Optimization (SEO)' ? 'selected' : ''); ?>>
            Search Engine Optimization (SEO)
            </option>
            <option value="Social Media Marketing" <?php echo e(old('services') == 'Social Media Marketing'
    ? 'selected' : ''); ?>>
            Social Media Marketing
            </option>
            <option value="Web Hosting" <?php echo e(old('services') == 'Web Hosting' ? 'selected' : ''); ?>>
            Web Hosting
            </option>
            <option value="Web Design & Development" <?php echo e(old('services') == 'Web Design & Development'
    ? 'selected' : ''); ?>>
            Web Design & Development
            </option>
            <option value="Web Maintenance" <?php echo e(old('services') == 'Web Maintenance' ? 'selected' : ''); ?>>
            Web Maintenance
            </option>
          </select>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="row align-items-center">
      ...
      <div class="row">
        ...
        <div class="industries_box service-item">
          <img src="<?php echo e(custom_asset('front_assets/icon/ecommerce.png')); ?>" alt="eCommerce" loading="lazy">
          <span>eCommerce</span>
        </div>
        </div>
        <div class="col-lg-3 col-md-3 col-6 mb-3">
        <div class="industries_box service-item">
          <img src="<?php echo e(custom_asset('front_assets/icon/healthcare.png')); ?>" alt="Healthcare" loading="lazy">
          <span>Healthcare</span>
        </div>
        </div>
        <div class="col-lg-3 col-md-3 col-6 mb-3">
        <div class="industries_box service-item">
          <img src="<?php echo e(custom_asset('front_assets/icon/travel.png')); ?>" alt="Travel" loading="lazy">
          <span>Travel</span>
        </div>
        </div>
        <div class="col-lg-3 col-md-3 col-6 mb-3">
        <div class="industries_box service-item">
          <img src="<?php echo e(custom_asset('front_assets/icon/realestate.png')); ?>" alt="Real State" loading="lazy">
          <span>Real State</span>
        </div>
        </div>
        <div class="col-lg-3 col-md-3 col-6 mb-3">
        <div class="industries_box service-item">
          <img src="<?php echo e(custom_asset('front_assets/icon/fitness.png')); ?>" alt="Fitness" loading="lazy">
          <span>Fitness</span>
        </div>
        </div>
        <div class="col-lg-3 col-md-3 col-6 mb-3">
        <div class="industries_box service-item">
          <img src="<?php echo e(custom_asset('front_assets/icon/resturent.png')); ?>" alt="Restaurant" loading="lazy">
          <span>Restaurant</span>
        </div>
        </div>
        <div class="col-lg-3 col-md-3 col-6 mb-3">
        <div class="industries_box service-item">
          <img src="<?php echo e(custom_asset('front_assets/icon/education-icpn.png')); ?>" alt="Restaurant" loading="lazy">
          <span>Education</span>
        </div>
        </div>
        <div class="col-lg-3 col-md-3 col-6 mb-3">
        <div class="industries_box service-item">
          <img src="<?php echo e(custom_asset('front_assets/icon/entertainment.png')); ?>" alt="Restaurant" loading="lazy">
          <span>Entertainment</span>
        </div>
        </div>
        <div class="col-lg-3 col-md-3 col-6 mb-3">
        <div class="industries_box service-item">
          <img src="<?php echo e(custom_asset('front_assets/icon/banking.png')); ?>" alt="Restaurant" loading="lazy">
          <span>Banking</span>
        </div>
        </div>
        <div class="col-lg-3 col-md-3 col-6 mb-3">
        <div class="industries_box service-item">
          <img src="<?php echo e(custom_asset('front_assets/icon/transport.png')); ?>" alt="Restaurant" loading="lazy">
          <span>Transport</span>
        </div>
        </div>
        <div class="col-lg-3 col-md-3 col-6 mb-3">
        <div class="industries_box service-item">
          <img src="<?php echo e(custom_asset('front_assets/icon/business.png')); ?>" alt="Restaurant" loading="lazy">
          <span>Business</span>
        </div>
        </div>
        <div class="col-lg-3 col-md-3 col-6 mb-3">
        <div class="industries_box service-item">
          <img src="<?php echo e(custom_asset('front_assets/icon/job-carrier.png')); ?>" alt="Restaurant" loading="lazy">
      ...
      <div class="main_servicing_f">
        ...
        providers <a href="<?php echo e(route('ecommerce_development')); ?>">ecommerce website development services</a> for
    ...
    <div class="tab-content" id="pills-tabContent">
      ...
      <div class="container">
        ...
        <div class="col-md-4 mb-4">
          ...
          <a href="https://greatmedia.in/"> <img src="<?php echo e(custom_asset('front_assets/img/greatmedia.webp')); ?>"
        ...
        <div class="col-md-4 mb-4">
          ...
          <a href="https://babycorngroup.com/"> <img
            src="<?php echo e(custom_asset('front_assets/img/Babycorngroup.webp')); ?>" alt="img" loading="lazy"></a>
          </div>
        </div>
        <div class="col-md-4 mb-4">
          <div class="pills_under_img">
          <a href="https://srishtiadmissionpoint.com/"> <img
            src="<?php echo e(custom_asset('front_assets/img/Srishti-Admission-Point-Get-Admission-in-Top-Indian-Universities.webp')); ?>"
            alt="img" loading="lazy"></a>
          </div>
        </div>
        <div class="col-md-4 mb-4">
          ...
          <a href="https://persdc.org/"> <img
            src="<?php echo e(custom_asset('front_assets/img/Pragyan-Educational-Research-Skill-Development-Council.webp')); ?>"
            alt="img" loading="lazy"></a>
          </div>
        </div>
        <div class="col-md-4 mb-4">
          ...
          <a href="https://digilearnclasses.com/"><img
            src="<?php echo e(custom_asset('front_assets/img/Computer-Course-Digital-Marketing-Course-Coding-Classes.webp')); ?>"
            alt="img" loading="lazy"></a>
          </div>
        </div>
        <div class="col-md-4 mb-4">
          ...
          <a href="https://drrichagupta.com/"> <img
            src="<?php echo e(custom_asset('front_assets/img/Gynaecologist-Near-Me.webp')); ?>" alt="img"
            loading="lazy"></a>
          </div>
        </div>
        </div>
  ...
  <section class="nav_tab_new_session padding">
    ...
    <div class="row">
      ...
      <div class="post-card">
        ...
        <img src="<?php echo e(custom_asset($blog->banner)); ?>" class="img-fluid img_bloger" alt="<?php echo e($blog->title); ?>"
        loading="lazy">
        </div>
        <div class="post-content-wrap">
        <ul class="post-meta">
        <li>
        <i class="las la-calendar"></i><?php echo e($blog->created_at->format('F j, Y')); ?>

        </li>
        </ul>
        <div class="post-content">
        <h3><a href="<?php echo e(url('blogs/' . $blog->slug)); ?>" class="hover"><?php echo e(Str::limit($blog->title, 52)); ?></a>
        </h3>
        <p><?php echo e(Str::limit($blog->short_description, 135, '...')); ?></p>
        </div>
        </div>
      </div>
      </div>
  ...
  <section class="testimonial-section-2 bg-grey padding">
    ...
    <div class="row align-items-center">
      ...
      <div class="testimonial-carousel-2 testimonial-card">
        ...
        <?php $__currentLoopData = $review_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reviewss): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

        <div class="swiper-slide">
        <div class="testi-item">
        <div class="quote-icon"><i class="las la-quote-right"></i></div>
        <p style="white-space: normal; word-break: break-word;">
          <?php echo e(\Illuminate\Support\Str::words($reviewss->review, 60, '...')); ?>

        </p>

        <div class="testi-author">
          <div class="author-infomain">
          <?php if(!empty($reviewss->image)): ?>
        <div>
        <img src="<?php echo e(asset('public/' . $reviewss->image)); ?>"
        style="width:40px;height:40px;border-radius:50%;object-fit:cover;">
        </div>
        <?php else: ?>
        <div class="author-initial">
        <?php echo e(strtoupper(substr($reviewss->name, 0, 1))); ?>

        </div>
        <?php endif; ?>
          <div class="author-info">
          <span><?php echo e($reviewss->name); ?></span>
      ...
      <div class="testi-item">
      <div class="quote-icon"><i class="las la-quote-right"></i></div>
      <p>We are a travel agency in the USA for flight tickets, hotels, and rental car booking. Digi
      Rush
      Solutions did a fantastic job designing and developing our website for Royal Care Travels.
      They
      ...
      <div class="testi-item">
      <div class="quote-icon"><i class="las la-quote-right"></i></div>
      <p>Digi Rush Solutions is the best digital marketing and web development agency in Chandigarh.
      They
      did their job designing and developing our eCommerce website for Adhya Bedsheet. They handled
      everything from the initial design to the full setup with great attention to detail. The
      result
      is a sleek, functional site that perfectly suits our needs. We’re thrilled with their work
      and
      ...
      created a professional, user-friendly site that perfectly meets my needs as a doctor. I’m
      very
      ...
      website.
      They provided a functional design that highlights our offerings and makes it easy for
      customers
      to navigate. Their expertise and attention to detail have greatly enhanced our online
      presence.
      </p>
      <div class="testi-author">
      <div class="author-infomain">
      ...
      Council). Digi Rush Solutions created a clean, professional design that perfectly represents
      our
      ...
      development for Router Ninjas. Their work has greatly improved how we present our router
      support
      services and IT solutions. The website is not only visually appealing but also highly
      functional
      and easy to navigate. We’re very impressed and strongly recommend Digi Rush Solutions for
      anyone
      ...
      vibrant,
      easy to navigate, and perfectly reflects our event organising services. We’re thrilled with
      the
      ...
      services
      especially Social Media Marketing and SEO. Our website traffic and engagement have
      significantly
  ...
  <section class="call-back-section padding">
    ...
    <div class="row align-items-center">
      ...
      <div class="callback-men"><img src="<?php echo e(custom_asset('front_assets/img/callback-men.webp')); ?>" alt="img"
        loading="lazy"></div>
      </div>
      <div class="col-lg-6 col-md-8 offset-lg-0 offset-md-2">
      <div class="callback-form ml-40">
        <h2>Request a Callback</h2>
        <form action="<?php echo e(route('quote.store')); ?>" method="post" class="form-horizontal" id="myform3">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
          ...
          <select name="service" id="service">
            ...
            <option value="Website Designing & Development" <?php echo e(old('service') == 'Website Designing & Development' ? 'selected' : ''); ?>>
            Website Designing & Development
            </option>
            <option value="Application Development" <?php echo e(old('service') == 'Application Development' ? 'selected' : ''); ?>>
            Application Development
            </option>
            <option value="Software Development" <?php echo e(old('service') == 'Software Development' ? 'selected' : ''); ?>>
            Software Development
            </option>
            <option value="CRM, ERP Development" <?php echo e(old('service') == 'CRM, ERP Development' ? 'selected' : ''); ?>>
            CRM, ERP Development
            </option>
            <option value="All Digital Marketing Services" <?php echo e(old('service') == 'All Digital Marketing Services' ? 'selected' : ''); ?>>
            All Digital Marketing Services
            </option>
            <option value="SEO Services" <?php echo e(old('service') == 'SEO Services' ? 'selected' : ''); ?>>
            SEO Services
            </option>
            <option value="SMO Services" <?php echo e(old('service') == 'SMO Services' ? 'selected' : ''); ?>>
            SMO Services
            </option>
            <option value="PPC Services" <?php echo e(old('service') == 'PPC Services' ? 'selected' : ''); ?>>
            PPC Services
            </option>
            <option value="Email Marketing" <?php echo e(old('service') == 'Email Marketing' ? 'selected' : ''); ?>>
            Email Marketing, SMS, Whatsapp Messages, Broadcast Services
            </option>
            <option value="Graphic Designing, Video Editing" <?php echo e(old('service') == 'Graphic Designing, Video Editing' ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
  ...
  <!-- <div class="modal fade" id="reviewModal" tabindex="-1" aria-labelledby="reviewModalLabel" aria-hidden="true">
      ...
      <input type="email" id="userEmail" class="form-control mb-3" placeholder="Enter your email">
      <button class="btn-submit" onclick="submitEmail()">Submit</button>
      </div>
      </div>
      </div>
     </div> -->
  ...
  <!-- <div class="modal fade" id="otpModal" tabindex="-1" aria-labelledby="otpModalLabel" aria-hidden="true">
      ...
      <div class="modal-body text-center">
      <input type="text" id="otpField" class="form-control mb-3" placeholder="Enter OTP">
  ...
  <!-- <div class="modal fade" id="reviewFormModal" tabindex="-1" aria-labelledby="reviewFormLabel" aria-hidden="true">
      ...
      <textarea class="form-control mb-2" placeholder="Share your experience"></textarea>
  ...
  <!-- <script>
      ...
      const emails = document.getElementById("userEmail").value.trim();
      if (emails === "") {
      alert("Please enter your email before proceeding.");
      return;
      }

      const emailModalEl = document.getElementById('reviewModal');
      const emailModal = bootstrap.Modal.getInstance(emailModalEl) || new bootstrap.Modal(emailModalEl);
      const otpModalEl = document.getElementById('otpModal');
      const otpModal = new bootstrap.Modal(otpModalEl);

      emailModal.hide();
      emailModalEl.classList.remove('show');
      ...
      $.ajax({
       url:'http://localhost/digirushsolutionscom_17july/send-review-otp',
       type:'POST',
       data:{
      ...
      //   if (otp === "") {
      //     alert("Please enter otp before proceeding.");
      //     return;
      //   }
      // Bina OTP verify kiye directly Review modal dikhao
      const otpModalEl = document.getElementById('otpModal');
      const otpModal = bootstrap.Modal.getInstance(otpModalEl) || new bootstrap.Modal(otpModalEl);
      ...
      $.ajax({
       url:'http://localhost/digirushsolutionscom_17july/review-otp-verify',
       type:'POST',
       data:{
      _token: '<?php echo e(csrf_token()); ?>',
      otp:otp
  ...
  <script>
    ...
    $.ajax({
      url: '<?php echo e(url("send-review-otp")); ?>',
      type: 'POST',
      data: {
      _token: '<?php echo e(csrf_token()); ?>',
      email: email
    ...
    $.ajax({
      url: '<?php echo e(url("/review-otp-verify")); ?>',
      type: 'POST',
      data: {
      _token: '<?php echo e(csrf_token()); ?>',
      otp: otp
...
<?php echo $__env->make('layouts.front.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\rahul\resources\views/home.blade.php ENDPATH**/ ?>