...
<?php $__env->startSection('content'); ?>
   ...
   <section class="page-header" style="background-image: url(<?php echo e(custom_asset('front_assets/img/seo_banner.png')); ?>);">
        ...
        <div class="row align-items-center">
          <div class="col-lg-6 sm-padding">
            ...
            <div class="about-content">
               ...
               <p>If your website doesn’t load quickly or doesn’t have an appealing design, visitors will leave without
                 hesitation. In such cases, it’s crucial to reach out to a <a href="<?php echo e(route('web_development')); ?>">web
          ...
          <div class="col-lg-6 sm-padding">
            <div class="about-thumb">
               <img src="<?php echo e(custom_asset('front_assets/img/programing_web.jpg')); ?>"
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6 col-md-12 col-12">
            ...
            </p> <a href="<?php echo e(route('contact')); ?>" class="default-btn btn_response">GET A FREE CONSULTATION</a>
          </div>
          <div class="col-lg-6 col-md-12 col-12">
                     ...
                     <div class="input-group">
                        <div class="input-group-prepend">
                          <select name="countryCode">
                            <option data-countryCode="IN" value="91" <?php echo e(old('countryCode') == '91'
      ? 'selected' : ''); ?>>Ind
                              (+91)</option>
                            <option data-countryCode="UK" value="44" <?php echo e(old('countryCode') == '44'
      ? 'selected' : ''); ?>>UK
                              (+44)</option>
                            <option data-countryCode="US" value="1" <?php echo e(old('countryCode') == '1'
      ? 'selected' : ''); ?>>US (+1)
                            </option>
                          </select>
                        </div>
...
unset($__errorArgs, $__bag); ?>
   ...
   <section class="web_logo_development  padding">
      <div class="container">
        ...
        <div class="tech-category">
          ...
          <div class="row">
            <div class="col-md-2 col-6 tech-box"><img
                 src="<?php echo e(custom_asset('front_assets/img/Angular-Js-by-Acmo.webp')); ?>" alt=""> AngularJS</div>
            <div class="col-md-2 col-6 tech-box"><img src="<?php echo e(custom_asset('front_assets/img/react.webp')); ?>" alt="">
               React</div>
            <div class="col-md-2 col-6 tech-box"><img src="<?php echo e(custom_asset('front_assets/img/javascript.webp')); ?>"
                 alt="">JavaScript</div>
            <div class="col-md-2 col-6 tech-box"><img src="<?php echo e(custom_asset('front_assets/img/html5.webp')); ?>" alt="">
               HTML5</div>
            <div class="col-md-2 col-6 tech-box"><img src="<?php echo e(custom_asset('front_assets/img/css.webp')); ?>" alt=""> CSS
            </div>
            <div class="col-md-2 col-6 tech-box"><img src="<?php echo e(custom_asset('front_assets/img/saas.webp')); ?>" alt="">
               SASS</div>
          </div>
        </div>
        ...
        <div class="tech-category">
          ...
          <div class="row">
            <div class="col-md-2 col-6 tech-box"><img src="<?php echo e(custom_asset('front_assets/img/php.webp')); ?>" alt=""> PHP
            </div>
            <div class="col-md-2 col-6 tech-box"><img src="<?php echo e(custom_asset('front_assets/img/c_main_play.webp')); ?>"
                 alt=""> C#</div>
            <div class="col-md-2 col-6 tech-box"><img src="<?php echo e(custom_asset('front_assets/img/node.webp')); ?>" alt="">
               NodeJS</div>
          </div>
        </div>
        ...
        <div class="tech-category">
          ...
          <div class="row">
            <div class="col-md-2 col-6 tech-box"><img src="<?php echo e(custom_asset('front_assets/img/express.webp')); ?>" alt="">
               Express.js</div>
            <div class="col-md-2 col-6 tech-box"><img src="<?php echo e(custom_asset('front_assets/img/laravel.png')); ?>" alt="">
               Laravel</div>
            <div class="col-md-2 col-6 tech-box"><img src="<?php echo e(custom_asset('front_assets/img/ACMOD.webp')); ?>" alt="">
               YII2</div>
            <div class="col-md-2 col-6 tech-box"><img src="<?php echo e(custom_asset('front_assets/img/symfony.webp')); ?>" alt="">
               Symfony</div>
            <div class="col-md-2 col-6 tech-box"><img src="<?php echo e(custom_asset('front_assets/img/aspnet.webp')); ?>" alt="">
               ASP.net MVC</div>
          </div>
        </div>
        ...
        <div class="tech-category">
          ...
          <div class="row">
            <div class="col-md-2 col-6 tech-box"><img src="<?php echo e(custom_asset('front_assets/img/mainly.webp')); ?>" alt="">
               OpenCart</div>
            <div class="col-md-2 col-6 tech-box"><img src="<?php echo e(custom_asset('front_assets/img/wordpress.webp')); ?>"
                 alt=""> WordPress</div>
            <div class="col-md-2 col-6 tech-box"><img src="<?php echo e(custom_asset('front_assets/img/jommla.webp')); ?>" alt="">
               Joomla</div>
          </div>
        </div>
        ...
        <div class="tech-category">
          ...
          <div class="row">
            <div class="col-md-2 col-6 tech-box"><img src="<?php echo e(custom_asset('front_assets/img/mysqul.webp')); ?>" alt="">
               MySQL</div>
            <div class="col-md-2 col-6 tech-box"><img src="<?php echo e(custom_asset('front_assets/img/postgresql.webp')); ?>"
                 alt=""> PostgreSQL</div>
            <div class="col-md-2 col-6 tech-box"><img src="<?php echo e(custom_asset('front_assets/img/mongodb.webp')); ?>" alt="">
               MongoDB</div>
            <div class="col-md-2 col-6 tech-box"><img src="<?php echo e(custom_asset('front_assets/img/elasticsearch.webp')); ?>"
                 alt=""> Elasticsearch</div>
            <div class="col-md-2 col-6 tech-box"><img src="<?php echo e(custom_asset('front_assets/img/redis.webp')); ?>" alt="">
               Redis</div>
          </div>
        </div>
      </div>
   ...
   <!--            </div>-->
   <!--            <div class="ahead_p">-->
   <!--                <p><a href="<?php echo e(route('seo_company')); ?>">Best SEO Services in India</a> | <a-->
   <!--                        href="<?php echo e(route('seo_company')); ?>">Best SEO Expert in India</a> |-->
   <!--                    <a href="<?php echo e(route('seo_company')); ?>">Affordable SEO Company India</a> | <a-->
   <!--                        href="<?php echo e(route('seo_company')); ?>">Top SEO Experts in India </a> | <a-->
   <!--                        href="<?php echo e(route('seo_company')); ?>">Low Cost SEO Services India </a>-->
   <!--                </p>-->
   <!--            </div>-->
   <!--        </div>-->
   <!--    </div>-->
            ...
            <div class="under_top_country">
               ...
               <div class="ul_flx_mai">
                 <ul>
                   ...
                   <li>
                     <a href="<?php echo e(route('web_service_uk')); ?>">United Kingdom (UK)</a>
                   </li>
                   <li>
          ...
          <div class="col-md-4">
            <div class="under_top_country">
               ...
               <div class="ul_flx_mai">
                 <ul>
                   <li>
                     <a href="<?php echo e(route('seo_agency_chandigarh')); ?>">SEO Agency in Chandigarh</a>
                   </li>
                   <li>
                     <a href="<?php echo e(route('seo_agency_delhi')); ?>">SEO Agency in Delhi (NCR)</a>
                   </li>
                   <li>
                     <a href="<?php echo e(route('seo_agency_jaipur')); ?>">SEO Agency in Jaipur</a>
                   </li>
                   <li>
                     <a href="<?php echo e(route('seo_agency_bangalore')); ?>">SEO Agency in Bangalore </a>
                   </li>
                   <li>
                     <a href="<?php echo e(route('seo_agency_in_pune')); ?>">SEO Agency in Pune </a>
                   </li>
                 </ul>
               </div>
            </div>
...
<?php echo $__env->make('layouts.front.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\rahul\resources\views/frontend/web_development.blade.php ENDPATH**/ ?>