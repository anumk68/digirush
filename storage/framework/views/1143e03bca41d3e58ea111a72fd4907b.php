<!--sidebar wrapper -->
		<div class="sidebar-wrapper" data-simplebar="true">
			...
			<ul class="metismenu" id="menu">
				...
				<li>
					...
					<ul>
						<li> <a href="<?php echo e(route('admin.blog')); ?>"><i class='bx bx-radio-circle'></i>Blog List</a>
						</li>
				...
				<li>
					<a href="<?php echo e(route('homePageSubmissions.index')); ?>">
		...
		<!--end sidebar wrapper --><?php /**PATH C:\xampp\htdocs\DigirushNew\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>