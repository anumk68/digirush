...
function mobileMenu() {
    ...
    // Only apply these handlers in mobile view
    if ($('body').hasClass('viewport-sm')) {
        $(".mobile-navigation-menu ul li.dropdown").each(function () {
            var $this = $(this);
            var $link = $this.find(".dropdown-link");
            var $submenu = $this.find(".dropdown-menu");
 
            // Add click handler for single click (open)
            ...
            // Add double click handler (close)
...
/*-----------------------------counter---------------------*/
    ...
    circles.forEach((circle, i) => {
      ...
      const target = +values[i].dataset.target;
      let current = 0;
...
/*--------banner new slider---------------*/
  ...
  $('.banner-slider').owlCarousel({
    ...
    onChanged: function(event) {
      ...
      tags.forEach(tag => {
        tag.classList.remove('animate__animated', 'animate__zoomIn');
        void tag.offsetWidth; 
        tag.classList.add('animate__animated', 'animate__zoomIn');
      });
    }
  });
...
/*-----------------------------counter---------------------*/
        //Testimonial Carousel 2
        var swiperTestimonial2 = new Swiper(".testimonial-carousel-3", {
            slidesPerView: 3,
            spaceBetween: 20,
            slidesPerGroup: 1,
            loop: true,
