                    ...
                    <table style="width: 100%;">
                        <tr>
                            <td>
                                ...
                                <h2 style="font-weight: 200; font-size: 20px; margin: 20px 0; color: #333333;">Service: {{$data['message']}} </h2>
                                <h2 style="font-weight: 200; font-size: 20px; margin: 20px 0; color: #333333;">Service: {{$data['form_type']}} </h2>
                                <p style="text-align: center; display: block; padding-top:20px; font-weight: bold; margin-top:30px; color: #666666; border-top:1px solid #dddddd;">Digirush Solutions US</p>
                            </td>
                        </tr>
                    </table>
                </div>
