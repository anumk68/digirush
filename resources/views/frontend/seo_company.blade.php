...
@section('content')
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 sm-padding">
                    ...
                    <div class="about-content">
                        <p>Welcome to Digi Rush Solutions, <a href="{{ route('local_seo_company') }}">affordable seo company
                                in
                ...
                <div class="col-lg-6 sm-padding">
                    <div class="about-thumb">
                        <img src="{{ custom_asset('front_assets/img/seo_commm.jpg')}}" alt="img">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="generate_moretraffic_site">
        <div class="container my-5">
            <div class="row align-items-center">
                <!-- Left Content -->
                <div class="col-md-6">
                    <h2 class="section-title">
                        Generate More Traffic to your <span class="highlight-line">Website</span>
                    </h2>
                    ...
                    <p><strong>So it is time to Get, set and go.</strong></p>

                    <p class="mt-4 fw-bold mb-1">SEO CONSULTANCY <span class="float-end">70%</span></p>
                    <div class="progress mb-3">
                        <div class="progress-bar progress-bar-yellow" role="progressbar" style="width: 70%"></div>
                    </div>

                    <p class="fw-bold mb-1 text-success">Market Research <span class="float-end">95%</span></p>
                    <div class="progress mb-3">
                        <div class="progress-bar progress-bar-green" role="progressbar" style="width: 95%"></div>
                    </div>

                    <p class="fw-bold mb-1 text-primary">SEO AUDIT <span class="float-end">55%</span></p>
                    <div class="progress mb-3">
                        <div class="progress-bar progress-bar-purple" role="progressbar" style="width: 55%"></div>
                    </div>
                    <a href="{{ route('contact') }}" class="default-btn btn_response">Get Started</a>
                    <!-- <button class="default-btn btn_response" ><i class="bi bi-list"></i> Get Started</button> -->
                </div>
