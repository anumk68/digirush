...
@section('content')
    ...
    <section class="page-header"
        style="background-image: url({{custom_asset('front_assets/img/bannner_hire_devloper.jpg')}});">
                ...
                <div class="col-md-5">
                    <div class="main_subscription_form  new_digital_form">
                        <div class="under_form_sestion">
                            ...
                            <form method="post" action="{{ route('hire.submit') }}" id="hire-contact-form">
                                @csrf
                        ...
                        <div class="owl-carousel owl-theme" id="flex_main_hire">
                            <div class="item">
                                <div class="img_devlop_hire">
                                    <a href="#"> <img src="{{ custom_asset('front_assets/img/frontent_project_1.jpg') }}"
                                            alt="Hire Expert Developer"></a>
                                </div>
                            </div>
                            <div class="item">
                                <div class="img_devlop_hire">
                                    <a href="#"> <img src="{{ custom_asset('front_assets/img/frontent_project_2.jpg') }}"
                                            alt="Hire Expert Developer"></a>
                                </div>
                            </div>
                            <div class="item">
                                <div class="img_devlop_hire">
                                    <a href="#"> <img src="{{ custom_asset('front_assets/img/frontent_project_3.jpg') }}"
                                            alt="Hire Expert Developer"></a>
                                </div>
                            </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12  mb-3">
                    <div class="under_hire_devloper">
                        ...
                        <div class="owl-carousel owl-theme flex_main_hires">
                            <div class="item">
                                <div class="img_devlop_hire">
                                    <a href="#"> <img src="{{ custom_asset('front_assets/img/frontent_project_4.jpg') }}"
                                            alt="Hire Expert Developer"></a>
                                </div>
                            </div>
                            <div class="item">
                                <div class="img_devlop_hire">
                                    <a href="#"> <img src="{{ custom_asset('front_assets/img/frontent_project_5.jpg') }}"
                                            alt="Hire Expert Developer"></a>
                                </div>
                            </div>
                            <div class="item">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12  mb-3">
                    <div class="under_hire_devloper">
                        ...
                        <div class="owl-carousel owl-theme flex_main_hires">
                            <div class="item">
                                <div class="img_devlop_hire">
                                    <a href="#"> <img src="{{ custom_asset('front_assets/img/wordpress_project_1.jpg') }}"
                                            alt="Hire Expert Developer"></a>
                                </div>
                            </div>
                            <div class="item">
                                <div class="img_devlop_hire">
                                    <a href="#"> <img src="{{ custom_asset('front_assets/img/wordpress_project_2.jpg') }}"
                                            alt="Hire Expert Developer"></a>
                                </div>
                            </div>
                            <div class="item">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12  mb-3">
                    <div class="under_hire_devloper">
                        ...
                        <div class="owl-carousel owl-theme flex_main_hires">
                            <div class="item">
                                <div class="img_devlop_hire">
                                    <a href="#"> <img src="{{ custom_asset('front_assets/img/shopify_project.png') }}"
                                            alt="Hire Expert Developer"></a>
                                </div>
                            </div>
                            <div class="item">
                                <div class="img_devlop_hire">
                                    <a href="#"> <img src="{{ custom_asset('front_assets/img/bryke.png') }}"
                                            alt="Hire Expert Developer"></a>
                                </div>
                            </div>
                            <div class="item">
                                <div class="img_devlop_hire">
                                    <a href="#"> <img src="{{ custom_asset('front_assets/img/iinnate_colletction.png') }}"
                                            alt="Hire Expert Developer"></a>
                                </div>
                            </div>
                            <div class="item">
                                <div class="img_devlop_hire">
                                    <a href="#"> <img src="{{ custom_asset('front_assets/img/pendulumilife.png') }}"
                                            alt="Hire Expert Developer"></a>
                                </div>
                            </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12  mb-3">
                    <div class="under_hire_devloper">
                        ...
                        <div class="owl-carousel owl-theme flex_main_hires">
                            <div class="item">
                                <div class="img_devlop_hire">
                                    <a href="#"> <img src="{{ custom_asset('front_assets/img/app_devlopemt_1.jpg') }}"
                                            alt="Hire Expert Developer"></a>
                                </div>
                            </div>
                            <div class="item">
            ...
            <div class="row">
                    ...
                    <div class="under_hiring_word">
                        <div class="img_hiring">
                            <img class="lazy loading bouncing-image"
                                src="{{ custom_asset('front_assets/img/hire_devloper_logos_1.png')}}" alt="Basic"
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 mb-4">
                    <div class="under_hiring_word">
                        <div class="img_hiring">
                            <img class="lazy loading bouncing-image"
                                src="{{ custom_asset('front_assets/img/hire_devloper_logos_2.png')}}" alt="Basic"
                                data-was-processed="true">
                        </div>
                        <div class="under_txt_hiring">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 mb-4">
                    <div class="under_hiring_word">
                        <div class="img_hiring">
                            <img class="lazy loading bouncing-image"
                                src="{{ custom_asset('front_assets/img/hire_devloper_logos_3.png')}}" alt="Basic"
                                data-was-processed="true">
                        </div>
                        <div class="under_txt_hiring">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 mb-4">
                    <div class="under_hiring_word">
                        <div class="img_hiring">
                            <img class="lazy loading bouncing-image"
                                src="{{ custom_asset('front_assets/img/hire_devloper_logos_4.png')}}" alt="Basic"
                                data-was-processed="true">
                        </div>
                        <div class="under_txt_hiring">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 mb-4">
                    <div class="under_hiring_word">
                        <div class="img_hiring">
                            <img class="lazy loading bouncing-image"
                                src="{{ custom_asset('front_assets/img/hire_devloper_logos_5.png')}}" alt="Basic"
                                data-was-processed="true">
                        </div>
                        <div class="under_txt_hiring">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 mb-4">
                    <div class="under_hiring_word">
                        <div class="img_hiring">
                            <img class="lazy loading bouncing-image"
                                src="{{ custom_asset('front_assets/img/hire_devloper_logos_6.png')}}" alt="Basic"
                                data-was-processed="true">
                        </div>
                        <div class="under_txt_hiring">
