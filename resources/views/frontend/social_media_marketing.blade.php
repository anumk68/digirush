...
<section class="page-header page-header-secnd" style="background-image: url({{ custom_asset('front_assets/img/social_media_banner.png')}});">
        ...
        <div class="row align-items-center">
            <div class="col-lg-6 sm-padding">
                ...
                <div class="about-content">
                   <p>Anybody can purchase followers, but the true test of any brand is organic growth that engages with you and generates quality leads. Digi Rush is a leading <a href="{{ route('social_media_marketing') }}">social media marketing agency in India</a> that assists you in achieving this by offering a wide range of social media optimization services that help your business grow its online presence.</p>
            ...
            <div class="col-lg-6 sm-padding">
                <div class="about-thumb">
                    <img src="{{ custom_asset('front_assets/img/smm_shoppingg.jpg')}}" alt="social media marketing agency in india">
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-6 ">
                        <div class="industries_box service-item">
                            <span class="reting">50x</span>
                            <p class="h_box">Develop Brand Awareness</p>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-6 ">
                        <div class="industries_box service-item">
                            <span class="reting">85%</span>
                ...
                <div class="row mt-3">
                        <div class="col-lg-6 col-md-6 col-6 ">
                            <div class="industries_box service-item">
                                ...
                                <p class="h_box">Increasing Website Exposure</p>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-6 ">
                            <div class="industries_box service-item">
                                <span class="reting">99%</span>
                                <p class="h_box">INCREASE QUALITY TRAFFIC</p>
                            </div>
                        </div>
                    </div>
            </div>
...
<section class="service-section bg-grey padding marketing_service_offer">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 py-2 sm-padding wow fade-in-bottom" data-wow-delay="300ms">
                <div class="service-item service_box best_box">
                       <img src="{{ custom_asset('front_assets/img/profile-picture.webp')}}" alt="profile-picture">
            ...
            <div class="col-lg-4 col-md-6 py-2 sm-padding wow fade-in-bottom" data-wow-delay="400ms">
                <div class="service-item service_box best_box">
                    <img src="{{ custom_asset('front_assets/img/Profile-Description.webp')}}" alt="Profile-Description">
            ...
            <div class="col-lg-4 col-md-12 py-2 sm-padding wow fade-in-bottom" data-wow-delay="500ms">
                <div class="service-item service_box best_box">
                    <img src="{{ custom_asset('front_assets/img/Provide-Complete-Information.webp')}}" alt="Provide-Complete-Information">
        ...
        <div class="row mt-3">
            <div class="col-lg-4 col-md-6 py-2 sm-padding wow fade-in-bottom" data-wow-delay="300ms">
                <div class="service-item service_box best_box">
                  <img src="{{ custom_asset('front_assets/img/Keywords-Are-Important.webp')}}" alt="Keywords-Are-Important">
            ...
            <div class="col-lg-4 col-md-6 py-2 sm-padding wow fade-in-bottom" data-wow-delay="400ms">
                <div class="service-item service_box best_box">
                    <img src="{{ custom_asset('front_assets/img/do-location.webp')}}" alt="do-location">
            ...
            <div class="col-lg-4 col-md-12 py-2 sm-padding wow fade-in-bottom" data-wow-delay="500ms">
                <div class="service-item service_box best_box">
                    <img src="{{ custom_asset('front_assets/img/updated.webp')}}" alt="Profile Updated">
