        ...
        <div class="row align-items-center">
            <div class="col-lg-6 col-md-12 col-sm-12">
                <div class="header_landng_logo">
                    <div class="site-logo">
                        <a href="{{url('/')}}"><img src="{{custom_asset('front_assets/img/F-Logo.png')}}" alt="digirusholution"></a>
                    </div>
                    <div class="ul_flx_main_head fdffg">
                        <ul class="number_box">
                            <li>
                             ...
                             <li>
                                <div class="mail_icon">
                                    <a href="mailto:contact@digirushsolutions.com"><i class="fa-solid fa-envelope"></i> contact@digirushsolutions.com</a>
                                </div>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="col-lg-6 col-md-12 col-sm-12">
                <div class="icon_landing">
                    <div class="img_off">
                        <img src="https://digirushsolutions.com/public/front_assets/img/GET-4.gif" alt="" class="img-fluid">
                    </div>
            ...
            <div class="col-lg-6 col-md-12 col-sm-12">
                <div class="home_landing_under">
                    <div class="under_txt_main">
                        ...
                        <p>At Digi Rush Solutions, we specialize in affordable web services designed to help businesses like yours to grow and succeed online.</p>
                        <ul>
                            <li><p>Fully Customized Web Development and Designing </p></li>
                            <li><p>100% Ownership Rights for Long-Term Flexibility</p></li>
                            <li><p>Analytics and Performance Tracking for Data-Driven Growth</p></li>
                            <li><p>Affordable & Transparent Pricing for High ROI</p></li>
                        </ul>
                        <div class="trust_pilot_logos">
                                ...
                                <div class="img_logo_pilot">
                                    <img src="{{ custom_asset('front_assets/img/Upwork-logo.png') }}" alt=""  class="img-fluid">
                                </div>

                                <div class="img_logo_pilot">
                                    <img src="{{ custom_asset('front_assets/img/freelancer.png') }}" alt=""  class="img-fluid">
                                </div>
                                <div class="img_logo_pilot">
                                    <img src="{{ custom_asset('front_assets/img/visualhunter.png') }}" alt=""  class="img-fluid">
                                </div>
                                ...
                                <ul>
                                    <li>
                                        <div class="real_statte  travel_color">
                                            <div class="content_txt">
                                                <div class="img_read">
                                                    <img src="{{ custom_asset('front_assets/img/travel_booking.png') }}" alt=""  class="img-fluid">
                                                </div>
                                    ...
                                    <li>
                                        <div class="real_statte education_color">
                                            <div class="content_txt">
                                                <div class="img_read">
                                                    <img src="{{ custom_asset('front_assets/img/education.png') }}" alt=""  class="img-fluid">
                                                </div>
                                                <h3>Education</h3>
                                            </div>
                                        </div>
                                    ...
                                    <li>
                                        <div class="real_statte manufacturing_color">
                                            <div class="content_txt">
                                                <div class="img_read">
                                                    <img src="{{ custom_asset('front_assets/img/manufacturring.png') }}" alt=""  class="img-fluid">
                                                </div>
                                                <h3>Manufacturing</h3>
                                            </div>
                                        </div>
                                ...
                                <ul>
                                    <li>
                                        <div class="real_statte banking_finance_color">
                                            <div class="content_txt">
                                                <div class="img_read">
                                                    <img src="{{ custom_asset('front_assets/img/banking_fiance.png') }}" alt=""  class="img-fluid">
                                                </div>
                                    ...
                                    <li>
                                        <div class="real_statte media_entertainment_color">
                                            <div class="content_txt">
                                                <div class="img_read">
                                                    <img src="{{ custom_asset('front_assets/img/media_entertainment.png') }}" alt=""  class="img-fluid">
                                                </div>
                                    ...
                                    <li>
                                        <div class="real_statte lifestyle_color">
                                            <div class="content_txt">
                                                <div class="img_read">
                                                    <img src="{{ custom_asset('front_assets/img/lifestyle.png') }}" alt=""  class="img-fluid">
                                                </div>
                                                <h3>Lifestyle</h3>
                                            </div>
                                        </div>
                                ...
                                <ul>
                                    <li>
                                        <div class="real_statte digital_color">
                                            <div class="content_txt">
                                                <div class="img_read">
                                                    <img src="{{ custom_asset('front_assets/img/digital_advertising.png') }}" alt=""  class="img-fluid">
                                                </div>
                                    ...
                                    <li>
                                        <div class="real_statte healthcare_color">
                                            <div class="content_txt">
                                                <div class="img_read">
                                                    <img src="{{ custom_asset('front_assets/img/healthcare.png') }}" alt=""  class="img-fluid">
                                                </div>
                                                <h3>Healthcare</h3>
                                            </div>
                                        </div>
                                    ...
                                    <li>
                                        <div class="real_statte sports_color">
                                            <div class="content_txt">
                                                <div class="img_read">
                                                    <img src="{{ custom_asset('front_assets/img/sports_fitness.png') }}" alt=""  class="img-fluid">
                                                </div>
                                ...
                                <ul>
                                    <li>
                                        <div class="real_statte social_color">
                                            <div class="content_txt">
                                                <div class="img_read">
                                                    <img src="{{ custom_asset('front_assets/img/social_network.png') }}" alt=""  class="img-fluid">
                                                </div>
                                    ...
                                    <li>
                                        <div class="real_statte estatte_color">
                                            <div class="content_txt">
                                                <div class="img_read">
                                                    <img src="{{ custom_asset('front_assets/img/real_estateee.png') }}" alt=""  class="img-fluid">
                                                </div>
                                                <h3>Real Estate</h3>
                                            </div>
                                        </div>
                                    ...
                                    <li>
                                        <div class="real_statte transportaion_color">
                                            <div class="content_txt">
                                                <div class="img_read">
                                                    <img src="{{ custom_asset('front_assets/img/transporation.png') }}" alt=""  class="img-fluid">
                                                </div>
            ...
            <div class="col-lg-6 col-md-12 col-sm-12">
                <div class="txt_cantered_main">
                    <div class="under_txt_indus">
                        ...
                        <p>We specialize in crafting unique and impactful web experiences for businesses across various industries. Our custom web development and web designing services are designed to drive growth, engagement and success in the digital world.</p>
                        <div class="btn_landing_page">
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">
                            Book A Free Demo
                              </button>
                ...
                <div class="under_website_devlop ">
                    <div class="main_under bg_color_one">
                        <div class="img_website">
                            <img src="{{ custom_asset('front_assets/img/business-logo-1.png') }}" alt="" class="img-fluid">
                        </div>
                        <div class="content_website_devlop">
                            <h3>Web Portal Solutions</h3>
                            <p>Custom web portals are designed to streamline business processes, increase user involvement and support better communication.</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-12 mb-3">
                <div class="under_website_devlop ">
                    <div class="main_under bg_color_two">
                        <div class="img_website">
                            <img src="{{ custom_asset('front_assets/img/business-logo-2.png') }}" alt="" class="img-fluid">
                        </div>
                        <div class="content_website_devlop">
                            <h3>Tailored Web Development</h3>
                            <p>We offer customized web development services to bring your vision into a completely functional, responsive website built to respond to your business needs.</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-12 mb-3">
                <div class="under_website_devlop">
                    <div class="main_under  bg_color_three">
                        <div class="img_website">
                            <img src="{{ custom_asset('front_assets/img/business-logo-3.png') }}" alt="" class="img-fluid">
                        </div>
                        <div class="content_website_devlop">
                            <h3>E-Commerce Solution</h3>
                            <p>Our e-commerce solutions will optimize the shopping experience online, providing scalable platforms to power sales and customer satisfaction.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 mb-3">
                <div class="under_website_devlop ">
                    <div class="main_under bg_color_four">
                        <div class="img_website">
                            <img src="{{ custom_asset('front_assets/img/business-logo-4.png') }}" alt="" class="img-fluid">
                        </div>
                        <div class="content_website_devlop">
                            <h3>Custom CMS Development</h3>
                            <p>We have custom CMS platforms designed and developed to give you full control of your content management using user-friendly interfaces and powerful features.</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-12 mb-3">
                <div class="under_website_devlop ">
                    <div class="main_under bg_color_five">
                        <div class="img_website">
                            <img src="{{ custom_asset('front_assets/img/business-logo-5.png') }}" alt="" class="img-fluid">
                        </div>
                        <div class="content_website_devlop">
                            <h3>Enterprise Web Solutions</h3>
                            <p>We have enterprise-grade web solutions, built with fit and integrating the right into your already existing systems for growth and scalable success for the long haul.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 mb-3">
                <div class="under_website_devlop ">
                    <div class="main_under bg_color_six">
                        <div class="img_website">
                            <img src="{{ custom_asset('front_assets/img/business-logo-6.png') }}" alt="" class="img-fluid">
                        </div>
                        <div class="content_website_devlop">
                            <h3>Continuous Web Support & Maintenance</h3>
                            <p>We offer continuous web support and maintenance services to ensure your website will be safe and updated and performing at its best.
                                </p>
                        </div>
                    </div>
                </div>
...
<section class="dynamic_brewing_section">
    <div class="container">
        <div class="heading_dynamic_main">
            ...
            <p>Employ an efficient and flexible method for their evolution to Web development applications that meet the client's needs and yield results.</p>
        </div>
        <div class="row align-items-center">
            <div class="col-lg-4 col-12">
                <div class="icons-container">
                    <div class="d-flex flex-column gap-4">
                        <div class="main_flx">
                            <img src="{{ custom_asset('front_assets/img/light-bulb.png') }}" alt="Planner" class="icons img-fluid" data-slide="0">
                            <h3>Planner</h3>
                        </div>
                        <div class="main_flx">
...
<section class="our_services_section">
    <div class="container">
        <div class="our_services_heading">
            ...
            <p>We take a careful, step-by-step approach to ensure that we achieve your business objectives and subsequently improve the business on the web.
            </p>
        </div>
        <div class="row align-items-center">
            <div class="col-lg-6 col-md-12 col-sm-12">
                <div class="row">
                    ...
                    <div class="col-md-3 col-6 mb-3">
                        <div class="img_logo">
                            <img src="{{ custom_asset('front_assets/img/wordpress_logo.svg') }}" alt="" class="img-fluid">
                            <h3>Wordpress</h3>
                        </div>
                    </div>
                    <div class="col-md-3 col-6 mb-3">
                        <div class="img_logo">
                            <img src="{{ custom_asset('front_assets/img/shopify_logo_new.png') }}" alt="" class="img-fluid">
                            <h3>shopify</h3>
                        </div>
                    </div>
                    <div class="col-md-3 col-6 mb-3">
...
<section class="why_choose_solution">
    <div class="container">
        <div class="heading_why_choose">
            ...
            <p>Digi Rush Solution has earned its reputation as one of the best web development and design firms by creating aesthetically pleasing and functional designs.</p>
        </div>
        <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-12">
                <div class="card-container main_first_color">
                    ...
                    <div class="card-content">
                      <p>Unique, responsive custom web designs that reflect your brand identity, ensuring user-friendly navigation.
                      </p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12">
                <div class="card-container main_second_color">
                    ...
                    <div class="card-content">
                      <p>We build SEO-friendly websites with optimized content and strategic keyword integration to boost visibility.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12">
                <div class="card-container main_third_color">
                    ...
                    <div class="card-content">
                      <p>Custom e-commerce solutions with secure payment gateways, user-friendly interfaces, inventory management, etc</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12">
                <div class="card-container main_fourth_color">
                    ...
                    <div class="card-content">
                      <p>Fast, secure websites with optimized performance, SSL encryption, robust security protocols, and quick load times.
                      </p>
                    </div>
                </div>
            </div>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="support_carousel_text">
                                <div class="content_support_cntnt">
                                    ...
                                    <p>For Loan Suvidhaa, we have integrated advanced loan calculators, secure application form and real-time loan status tracking, ensuring a smooth, user-friendly experience. Additionally, we’ve optimized mobile responsiveness and implemented robust data security measures for enhanced performance and privacy.</p>
                                    <div class="btn_landing_page support_maintain_btn">
                                       <a href="https://loansuvidhaa.com/"> <button type="button" class="btn btn-primary" >
                                            Visit Site
                                        </button></a>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                             ...
                             <img src="{{ custom_asset('front_assets/img/loan_suvidha.png') }}" alt="Maintenance">
                                </a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="support_carousel_text">
                                ...
                                <div class="content_support_cntnt">
                                    ...
                                    <p>For the Great Media website, we crafted a visually engaging, mobile-responsive design, incorporating interactive elements and SEO-optimized content. The site is designed for fast load times and easy navigation, ensuring an exceptional user experience across all devices.</p>
                                    <div class="btn_landing_page support_maintain_btn">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                             ...
                             <img src="{{ custom_asset('front_assets/img/great_media_in.png') }}" alt="Maintenance">
                                </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="support_carousel_text">
                                ...
                                <div class="content_support_cntnt">
                                    ...
                                    <p>For the Baby Corn Group website, we provided custom web development with SEO optimization, integrated secure contact forms and implemented real-time data updates. Additionally, we ensure ongoing performance monitoring, security patching and content management support for seamless user experience.</p>
                                    <div class="btn_landing_page support_maintain_btn">
                                 <a href="https://babycorngroup.com/"> <button type="button" class="btn btn-primary" >
                                           Visit Site
                                        </button></a>
                                    </div>
                                </div>
           ...
           <div class="col-12">
               <div class="marquee-container mb-4">
                 <div class="marquee-left">
                    <div class="marquee-content">
                       <img src="{{ custom_asset('front_assets/img/client_logo_1.png') }}" alt="Client Logo" class="mx-4">
                       <img src="{{ custom_asset('front_assets/img/client_logo_2.png') }}" alt="Client Logo" class="mx-4">
                       <img src="{{ custom_asset('front_assets/img/client_logo_3.png') }}" alt="Client Logo" class="mx-4">
                       <img src="{{ custom_asset('front_assets/img/Modern Sales.png') }}" alt="Client Logo" class="mx-4">
                        
                       <img src="{{ custom_asset('front_assets/img/client_logo_6.png') }}" alt="Client Logo" class="mx-4">
                       <img src="{{ custom_asset('front_assets/img/client_logo_7.png') }}" alt="Client Logo" class="mx-4">
                       <img src="{{ custom_asset('front_assets/img/sristi_main.png') }}" alt="Client Logo" class="mx-4">
                       <img src="{{ custom_asset('front_assets/img/client_logo_3.png') }}" alt="Client Logo" class="mx-4">
                       <img src="{{ custom_asset('front_assets/img/Modern Sales.png') }}" alt="Client Logo" class="mx-4">
                        <img src="{{ custom_asset('front_assets/img/sristi_main.png') }}" alt="Client Logo" class="mx-4">
                    </div>
              ...
              <div class="marquee-container">
                 <div class="marquee-right">
                        <div class="marquee-content">
                            <img src="{{ custom_asset('front_assets/img/client_logo_8.jpg') }}" alt="Client Logo" class="mx-4">
                            <img src="{{ custom_asset('front_assets/img/client_logo_9.png') }}" alt="Client Logo" class="mx-4">
                            <img src="{{ custom_asset('front_assets/img/client_logo_10.png') }}" alt="Client Logo" class="mx-4">
                            <img src="{{ custom_asset('front_assets/img/Shivanghi Electronics logo.png') }}" alt="Client Logo" class="mx-4">
                            <img src="{{ custom_asset('front_assets/img/client_logo_12.png') }}" alt="Client Logo" class="mx-4">
                 
                            <img src="{{ custom_asset('front_assets/img/client_logo_13.png') }}" alt="Client Logo" class="mx-4">
                            <img src="{{ custom_asset('front_assets/img/client_logo_14.png') }}" alt="Client Logo" class="mx-4">
                            <img src="{{ custom_asset('front_assets/img/client_logo_15.png') }}" alt="Client Logo" class="mx-4">
                            <img src="{{ custom_asset('front_assets/img/client_logo_16.png') }}" alt="Client Logo" class="mx-4">
                            <img src="{{ custom_asset('front_assets/img/sristi_main.png') }}" alt="Client Logo" class="mx-4">
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 mb-3">
                <div class="txt_cantered_main devlopment_css">
                    <div class="txt_app_devloper">
                        ...
                        <p>Digi Rush Solutions is acknowledged as the best company that provides quality web development services to let the companies gain a solid online foundation. From developers, designers and strategists to bring innovative solutions to the table responsive and user-friendly websites tailored to specific client requirements. True excellence is being a step ahead of the rest of the industry with what is next latest technologies to continue refining performance and user experience. Trust Digi Rush to create a website that looks good and really works for your business.</p>
                    </div>
               </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-12 mb-3">
                ...
                <div class="testimonial_slider">
                    <div class="slider">
                        <div class="laginator_main_travel">
                            ...
                            <div class="under_ycc">
                                <div class="content">
                                    <p>Digi Rush Solutions helped us build our Wix site, Super Dope Goodz, and we are happy with the results! The team’s innovative design, mobile optimization and smooth shopping experience have significantly increased both traffic and sales. Highly recommended!</p>
                        ...
                        <div class="laginator_main_travel">
                            <div class="img_reiews_webite">
                                <img src="{{ custom_asset('front_assets/img/just_jadu.webp') }}" alt="Client Logo" class="just_jadau_logo img-fluid" >
                            </div>
                            <div class="under_ycc">
                                <div class="content">
                                    <p>Digi Rush Solutions help us to develop our e-commerce site, Just Jadau. They created a beautifully designed, functional platform with custom product pages and a secure checkout. We've seen significant growth with our website. Very good work team.</p>
                                    <h4>Just Jadau</h4>
                                </div>
                            </div>
                        </div>
                        <div class="laginator_main_travel">
                            <div class="img_reiews_webite">
                                <img src="{{ custom_asset('front_assets/img/client_logo_17.webp') }}" alt="Client Logo" class="img-fluid">
                            </div>
                            <div class="under_ycc">
                                <div class="content">
                                    <p>The development team from Digi Rush Solutions has delivered a clean, professional and user-friendly platform that enhances customer experience. We've seen improved engagement and inquiries. We must recommend Digi Rush Solutions for industry-specific websites!</p>
                                    <h4> Loan Suvidhaa</h4>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="laginator_main_travel">
                            <div class="img_reiews_webite">
                                <img src="{{ custom_asset('front_assets/img/royalcare-logo (2).jpg') }}" alt="Client Logo" class="just_jadau_logo img-fluid">
                            </div>
                            <div class="under_ycc">
                                <div class="content">
                                    <p>We partnered with Digi Rush Solutions to create our Shopify store for Woof Blankets and the results exceeded expectations! Their expertise in e-commerce design, attention to detail and seamless user experience have boosted our conversions. Highly recommend Digi Rush Solutions!</p>
                    ...
                    <div class="accordion accordion-flush" id="accordionFlushExample">
                        <div class="accordion-item">
                            ...
                            <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                                <div class="accordion-body">Digi Rush Solutions provides full web development, with the requirement of a customized website design, e-commerce solutions, CMS development, responsive web design and constant after-sales and maintenance support.
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            ...
                            <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
                                <div class="accordion-body">A results-based approach, rigorous industry best practices, cutting-edge technologies and comprehensive testing will ensure that our web solutions meet your business objectives and deliver the best user experience. 
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            ...
                            <div id="flush-collapseThree" class="accordion-collapse collapse" aria-labelledby="flush-headingThree" data-bs-parent="#accordionFlushExample">
                                <div class="accordion-body">Businesses are catered for, including the government, start-ups, small to medium-sized enterprises, health, retail, education, and many more, all about their unique and particular solutions.</div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            ...
                            <div id="flush-collapsefour" class="accordion-collapse collapse" aria-labelledby="flush-headingfour" data-bs-parent="#accordionFlushExample">
                                <div class="accordion-body">The overall time needed depends on the project's complexity and scope. Generally, an average website would take 4 to 8 weeks, while larger, more complex solutions take more time.
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            ...
                            <div id="flush-collapsefive" class="accordion-collapse collapse" aria-labelledby="flush-headingfive" data-bs-parent="#accordionFlushExample">
                                <div class="accordion-body">Digi Rush Solutions is different from others due to its intense customization of solutions, agility in developing processes and dedicated team that tries to ensure the delivery of quality web solutions on time and within budget.</div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="flush-headingsixs">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapsesixs" aria-expanded="false" aria-controls="flush-collapsesixs">
                                Is there support offered after the launch or post-launch maintenance services?

                                </button>
                            </h2>
                            <div id="flush-collapsesixs" class="accordion-collapse collapse" aria-labelledby="flush-headingsixs" data-bs-parent="#accordionFlushExample">
                                <div class="accordion-body">Yes! We provide after-launch support and maintenance services, so you can always be assured that your website will continue to be functional, secure and current with new features and technological enhancements.</div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3">
                    ...
                    <div class="site-logo">
                        <a href="https://digirushsolutions.com"><img src="https://digirushsolutions.com/public/front_assets/img/F-Logo.png" alt="digirusholution"></a>
                    </div>
