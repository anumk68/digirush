        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 sm-padding">
                <div class="about-thumb">
                    <img src="{{ custom_asset('front_assets/img/laptop_shopping_imgg.jpg')}}" alt="img">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row align-items-end">
            <div class="col-lg-6 col-md-12 col-12">
                ...
                <p>
                Digi Rush Solutions is a leading eCommerce SEO agency and an <a href="{{ route('web_development') }}">eCommerce website development company in India</a> that helps online businesses grow. Our eCommerce SEO services include keyword research to improve your visibility and bring you the best results in today’s competitive online market.
                </p>
