...
@section('content')
    <section class="page-header page-header-secnd"
        style="background-image: url({{ custom_asset('front_assets/img/web_design_banner.png')}});">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 sm-padding">
                    <div class="about-thumb">
                        <img src="{{ custom_asset('front_assets/img/side_view_main.jpg')}}"
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-12 col-12">
                    ...
                    <p>As an affordable web design agency, we understand the importance of delivering exceptional value.
                        ...
                        Whether you want to hire a web designer or seek the <a href="{{route('home')}}">best website design
