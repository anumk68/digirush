...
@section('content')
<section class="page-header page-header-secnd" style="background-image: url({{ custom_asset('front_assets/img/web_design_banner.png')}});">
   ...
   <div class="container">
        <div class="row align-items-center">
            <div class="col-md-7">
                ...
                <p>Crafting exceptional and user-friendly websites that elevate your brand and drive online success in the competitive digital landscape.
                </p>
      ...
      <div class="row align-items-center">
            <div class="col-lg-6 sm-padding">
                    ...
                    <div class="about-content">
                        <p>Having a well-designed website is crucial for every business. Your website is often the first impression potential clients have of your brand. It can significantly impact their decision to engage with you or move on to a competitor. While there are many DIY website builders available, you still need a professional <a href="{{ route('web_designing') }}"> web design company in India</a> to achieve the best results.</p>
                        <p>Professional web designers possess the expertise and knowledge to create a website that not only looks visually appealing but also functions optimally. They understand the importance of user experience (UX) design, ensuring that your website is easy to navigate, loads quickly, and is compatible with different devices and browsers. Whether you need creative landing page design or eCommerce website design, a well-designed website enhances your credibility and encourages visitors to explore your site further.
                        </p>
            ...
            <div class="col-lg-6 sm-padding">
                ...
                <img src="{{ custom_asset('front_assets/img/side_view_main.jpg')}}" alt="web design company in india">
                </div>
            </div>
      </div>
   </div>
...
<section class="progress-section bg-grey padding">
   ...
   <div class="row align-items-center">
      <div class="col-lg-6 col-md-12 col-12">
         ...
         <p>Digi Rush Solutions is the best responsive web design company in India. We have a talented team of local web designers who provide outstanding custom design and development services. Our goal is to offer you cost-effective solutions without compromising on quality.
         </p>
         <p>As an affordable web design agency, we understand the importance of delivering exceptional value. Choose Digi Rush Solutions for your web design needs, and you’ll benefit from our experienced team, cost-effective solutions, and a website that stands out in today’s competitive digital landscape. Whether you want to hire a web designer or seek the <a href="{{route('home')}}">best website design and development company in India</a>, contact us to discuss how we can help your business succeed online.
         </p>
...
<section class="service-section bg-grey padding marketing_service_offer">
   ...
   <div class="container">
      <div class="section-heading text-center mb-40 wow fade-in-bottom" data-wow-delay="200ms">
         ...
         <p class="quality_main">Your website is a business tool intended to deliver measurable results (website traffic, leads and
      ...
      <div class="row">
         ...
         <div class="col-lg-4 col-md-6 mb-3 sm-padding wow fade-in-bottom" data-wow-delay="400ms">
            <div class="service-item service_box best_box">
               ...
               <p>When a customer opens your website, the landing page is the first thing they see. Consequently, the creative landing page design should be impressive and eye-catching enough to increase lead conversion rates. Digi Rush specializes in the development of SEO and PPC-friendly, high-performance landing pages that capture attention and drive results.
               </p>
            </div>
         </div>
         <div class="col-lg-4 col-md-12 mb-3 sm-padding wow fade-in-bottom" data-wow-delay="500ms">
            <div class="service-item service_box best_box">
               ...
               <p>Currently, WordPress is one of the most popular platforms for web design. Why? Well, WordPress stands out from other web design platforms due to its flexibility. As a WordPress website design company, Digi Rush Solutions provides complete services such as WordPress theme design, WordPress migration services, and more, ensuring your site meets all your business needs.</p>
            </div>
         </div>
      </div>
      <div class="row">
         ...
         <div class="col-lg-4 col-md-6 mb-3 sm-padding wow fade-in-bottom" data-wow-delay="400ms">
            <div class="service-item service_box best_box">
               ...
               <p>Now that everyone has a mobile phone, users are not limited to only using laptops and desktop computers to access information. Therefore, having a responsive design website is crucial if you want to remain competitive in the market. As a leading responsive web design company, Digi Rush's designers code the stylesheet of your website to ensure it automatically adjusts its layout on any device, providing an optimal user experience for all visitors.
               </p>
            </div>
         </div>
         <div class="col-lg-4 col-md-12 mb-3 sm-padding wow fade-in-bottom" data-wow-delay="500ms">
            <div class="service-item service_box best_box">
               ...
               <p>Already have a website? But is it too out of date? No issues! Our team is here to assist you with our website redesigning services in India. Through our custom solutions, we give your website a complete makeover, making it aesthetically pleasing and ensuring that your visitors convert into genuine leads. With new features such as a Click-to-Call button, Contact Forms, Downloads, and more, your website will look and function like a brand new one.
               </p>
            </div>
         </div>
      </div>
                ...
                <ul class="tab-list on_page_optimization  targeted_jquery">
                    <div class="accordion">
                        <div class="accordion-section">
                            ...
                            do I need a website development company? <span class="plus">+</span><span class="minus">-</span></a>
                        ...
                        <div class="accordion-section">
                            <a href="#accordion-3" class="accordion-section-title">How long does it take to build a website? <span class="plus">+</span><span class="minus">-</span></a>
                        ...
                        <div class="accordion-section">
                            <a href="#accordion-4" class="accordion-section-title"> What are the sources employed to build a website? <span class="plus">+</span><span class="minus">-</span></a>
                        ...
                        <div class="accordion-section">
                            <a href="#accordion-5" class="accordion-section-title"> Can you provide responsive web development services?<span class="plus">+</span><span class="minus">-</span></a>
                        ...
                        <div class="accordion-section">
                            ...
                            it possible for me to edit my website on my own?<span class="plus">+</span><span class="minus">-</span></a>
                    ...
                    <div class="under_top_country mb-0">
                        ...
                        <div class="ul_flx_mai">
                            ...
                            <a href="{{ route('content_management') }}">Content Management Marketing</a>
                                ...
                                <li>
                               <a href="{{ route('local_seo_company') }}">Local SEO</a>
                                </li>
                                <li>
