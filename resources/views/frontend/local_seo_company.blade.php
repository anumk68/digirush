...
@section("content")
    ...
    <section class="page-header page-header-secnd" style="background-image: url({{ custom_asset('front_assets/img/banner_local__seoo.png')}});">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 sm-padding">
                    <div class="about-thumb">
                        <img src="{{ custom_asset('front_assets/img/3d-view-map.png')}}" alt="img">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-12 col-12">
                    ...
                    <p>Local SEO services are an absolute must if you want to increase your online visibility in your local region or community. By optimizing your website and your online profile for location-based search, you will dramatically increase your local customer visibility. This targeted approach, part of the <a href="{{ route('seo_company') }}">best SEO services in India,</a> will bring more qualified visitors to your website and will also enhance your chances of converting those visitors into customers. Investing in local SEO not only boosts traffic but also helps build strong relationships within your community.</p>
