...
@section('content')
    ...
    <section class="page-header"
        style="background-image: url({{ custom_asset('front_assets/img/agency_jaipur_banner.png')}});">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 sm-padding">
                    <div class="about-thumb">
                        <img src="{{ custom_asset('front_assets/img/SEO-AGENCY-IN-JAIPUR (1).jpg')}}"
                            alt="seo-agency-jaipur">
                    </div>
                </div>
            </div>
        </div>
