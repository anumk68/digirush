...
@section("content")
    <section class="page-header page-header-secnd"
        style="background-image: url({{ custom_asset('front_assets/img/blog_banner.png')}});">
                            ...
                            <div class="col-lg-4 col-md-6 col-12 padding-15">
                                <div class="post-card">
                                    <div class="post-thumb">
                                        <a href="{{ url('blogs') . '/' . $blog->slug }}" class="hover"><img
                                                src="{{ custom_asset($blog->banner) }}" class="img-fluid img_bloger"></a>
                                    ...
                                    <div class="post-content-wrap">
                                        ...
                                        <div class="post-content main_post_blog_cntnt">
                                            <h3><a href="{{ url('blogs') . '/' . $blog->slug }}" class="hover">
                                                    {{ strlen($blog->title) > 80 ? Str::limit($blog->title, 80) : $blog->title }}</a>
                                            </h3>
                                            <p><a href="{{ url('blogs') . '/' . $blog->slug }}"
                                                    class="hover">{{substr($blog->short_description, 0, 80)}} ... </a></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                $(document).on('click', '.pagination a', function (e) {
                    ...
                    $.ajax({
                        ...
                        error: function () {
                            ...
                            $('.pagination-wrapper').html('{{ $blogs->links("pagination::bootstrap-5") }}');
                            $('.pagination-wrapper .pagination-info').remove();
                        }
                    });
                });
