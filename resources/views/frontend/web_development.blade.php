...
<div class="section-heading mb-40">
    <span class="sub-heading">Technologies for Advanced Web</span>
         <h2>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quis tempore commodi id? </h2>
    </div>
  <!-- Frontend -->
  <div class="tech-category">
    <h5 class="tech-title">Frontend</h5>
    <div class="row">
      <div class="col-md-2 col-6 tech-box"><img src="{{ custom_asset('front_assets/img/Angular-Js-by-Acmo.webp') }}" alt=""> AngularJS</div>
      <div class="col-md-2 col-6 tech-box"><img src="{{ custom_asset('front_assets/img/react.webp') }}" alt=""> React</div>
      <div class="col-md-2 col-6 tech-box"><img src="{{ custom_asset('front_assets/img/javascript.webp') }}" alt="">JavaScript</div>
      <div class="col-md-2 col-6 tech-box"><img src="{{ custom_asset('front_assets/img/html5.webp') }}" alt=""> HTML5</div>
      <div class="col-md-2 col-6 tech-box"><img src="{{ custom_asset('front_assets/img/css.webp') }}" alt=""> CSS</div>
      <div class="col-md-2 col-6 tech-box"><img src="{{ custom_asset('front_assets/img/saas.webp') }}" alt=""> SASS</div>
    </div>
  </div>
  ...
  <div class="tech-category">
    ...
    <div class="row">
      <div class="col-md-2 col-6 tech-box"><img src="{{ custom_asset('front_assets/img/php.webp') }}" alt=""> PHP</div>
    <div class="col-md-2 col-6 tech-box"><img src="{{ custom_asset('front_assets/img/c_main_play.webp') }}" alt=""> C#</div>
      <div class="col-md-2 col-6 tech-box"><img src="{{ custom_asset('front_assets/img/node.webp') }}" alt=""> NodeJS</div>
    </div>
  </div>
  ...
  <div class="tech-category">
    ...
    <div class="row">
      <div class="col-md-2 col-6 tech-box"><img src="{{ custom_asset('front_assets/img/express.webp') }}" alt=""> Express.js</div>
      <div class="col-md-2 col-6 tech-box"><img src="{{ custom_asset('front_assets/img/laravel.png') }}" alt=""> Laravel</div>
      <div class="col-md-2 col-6 tech-box"><img src="{{ custom_asset('front_assets/img/ACMOD.webp') }}" alt=""> YII2</div>
      <div class="col-md-2 col-6 tech-box"><img src="{{ custom_asset('front_assets/img/symfony.webp') }}" alt=""> Symfony</div>
      <div class="col-md-2 col-6 tech-box"><img src="{{ custom_asset('front_assets/img/aspnet.webp') }}" alt=""> ASP.net MVC</div>
    </div>
  </div>
  ...
  <div class="tech-category">
    ...
    <div class="row">
      <div class="col-md-2 col-6 tech-box"><img src="{{ custom_asset('front_assets/img/mainly.webp') }}" alt=""> OpenCart</div>
      <div class="col-md-2 col-6 tech-box"><img src="{{ custom_asset('front_assets/img/wordpress.webp') }}" alt=""> WordPress</div>
      <div class="col-md-2 col-6 tech-box"><img src="{{ custom_asset('front_assets/img/jommla.webp') }}" alt=""> Joomla</div>
    </div>
  </div>
  ...
  <div class="tech-category">
    ...
    <div class="row">
      <div class="col-md-2 col-6 tech-box"><img src="{{ custom_asset('front_assets/img/mysqul.webp') }}" alt=""> MySQL</div>
      <div class="col-md-2 col-6 tech-box"><img src="{{ custom_asset('front_assets/img/postgresql.webp') }}" alt=""> PostgreSQL</div>
      <div class="col-md-2 col-6 tech-box"><img src="{{ custom_asset('front_assets/img/mongodb.webp') }}" alt=""> MongoDB</div>
      <div class="col-md-2 col-6 tech-box"><img src="{{ custom_asset('front_assets/img/elasticsearch.webp') }}" alt=""> Elasticsearch</div>
      <div class="col-md-2 col-6 tech-box"><img src="{{ custom_asset('front_assets/img/redis.webp') }}" alt=""> Redis</div>
    </div>
  </div>
</div>
