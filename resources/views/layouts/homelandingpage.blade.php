...
<section id="canvas" class="landing_banner_home" style="background-image: url({{custom_asset('front_assets/img/home-landing-11.jpg')}});">
    <div class="container">
        <div class="row">
            <div class="col-md-7">
                <div class="txt_landing_min">
                    <div class="main_landing_txxxt">
                        ...
                        <h1>Stunning Web Design Starting 
                             at <span class="only"> Rs3999 ONLY</span></h1>
                            <p>At Digi Rush Solutions, we create dynamic, user-friendly websites for all industries. Offering sleek designs or functional web applications, we provide high-quality solutions at affordable prices, accessible to everyone.</p>
                            <ul class="grow">
                                <li><i class="fa-solid fa-check"></i>Grow Your Global Online Presence</li>
                                <li><i class="fa-solid fa-check"></i>Designing Responsive, User-Focused Websites</li>
                                <li><i class="fa-solid fa-check"></i>Engage, Grow, and Retain Your Audience </li>
                                <li><i class="fa-solid fa-check"></i>Full 100% Website Ownership</li>
                            </ul>
    ...
    <div class="row">
        <div class="col-md-3 mb-4">
            <div class="under_main_specialization">
                ...
                <div class="txt_special_lization">
                    ...
                    <p>At Digital Web Services, we create visually beautiful and consumer-friendly websites that excellent constitute your logo. From concept to launch, our crew works closely with you to make certain your internet site exceeds your expectations and drives consequences.</p>
                </div>
            </div>
        </div>
        <div class="col-md-3 mb-4">
            <div class="under_main_specialization">
                ...
                <div class="txt_special_lization">
                    <h2>Graphic Designing, Video Editing</h2>
                    <p>Elevate your brand with captivating visuals and engaging films from Digital Web Services. Our proficient group creates stunning pix and compelling video content material, tailor-made in your logo's unique vision and target audience.</p>
                </div>
            </div>
        </div>
        <div class="col-md-3 mb-4">
            <div class="under_main_specialization">
                ...
                <div class="txt_special_lization">
                    <h2>CRM, ERP Development</h2>
                    <p>Simplify and improve productivity with custom CRM and ERP answers advanced by means of our skilled group. We will work with you to recognize your unique wishes and expand answers that assist you manage your client relationships and operations more effectively.</p>
                </div>
            </div>
        </div>
        <div class="col-md-3 mb-4">
            <div class="under_main_specialization">
                ...
                <div class="txt_special_lization">
                    ...
                    <p>Need customized software solutions to solve precise challenges on your organization? Our software improvement crew has the expertise to create sturdy and scalable programs that meet your business wishes.</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3 mb-4">
            <div class="under_main_specialization">
                ...
                <div class="txt_special_lization">
                    <h2>SEO Services</h2>
                    <p>Increase your visibility in SERPs and force natural traffic on your internet site with our advanced search engine optimization offerings. From keyword research to on-web page optimization, we’ll assist you climb search engine rankings and entice extra ability customers.</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3 mb-4">
            <div class="under_main_specialization">
                <div class="img_specia">
                    <img src="{{custom_asset('front_assets/img/coding_6.png')}}" alt="">
                </div>
                <div class="txt_special_lization">
                    <h2>PPC Services</h2>
                    <p>Reach your target market effectively and force qualified traffic in your website with our PPC offerings. Our crew will expand and manage strategic pay-in line with-click campaigns that maximize your go back on investment and drive effects.</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3 mb-4">
            <div class="under_main_specialization">
                <div class="img_specia">
                    <img src="{{custom_asset('front_assets/img/coding_7.png')}}" alt="">
                </div>
                <div class="txt_special_lization">
                    <h2>Application Development</h2>
                    <p>Whether you require a cellular app, web app, or laptop application, our improvement group has the skills and experience to carry your thoughts to existence. From concept to release, we'll work with you every step of the way to make certain your software meets your needs and exceeds your expectancies.</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3 mb-4">
            <div class="under_main_specialization">
                ...
                <div class="txt_special_lization">
                    ...
                    <p>Stay connected along with your target audience and pressure engagement with our e-mail marketing services. From crafting compelling content material to designing fascinating templates, we will help you create e-mail campaigns that pressure consequences and keep your audience coming returned for greater.</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 col-md-12 col-12">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-6 ">
                        <div class="industries_box service-item">
                            <h3 class="reting">320m</h3>
                            <h5 class="h_box">Digital global audience reach</h5>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-6 ">
                        <div class="industries_box service-item">
                            <h3 class="reting">89%</h3>
                            <h5 class="h_box">Of the audience is under 34 years old</h5>
                        </div>
                    </div>
                ...
                <div class="row mt-3">
                    <div class="col-lg-6 col-md-6 col-6 ">
                        <div class="industries_box service-item">
                            <h3 class="reting">1350</h3>
                            <h5 class="h_box">Content pieces produced everyday</h5>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-6 ">
                        <div class="industries_box service-item">
                            <h3 class="reting">94%</h3>
                            <h5 class="h_box">Of the audience is under 34 years old</h5>
                        </div>
                    </div>
                </div>
