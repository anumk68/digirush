            ...
            <div class="number">
                ...
                <div class="btn-sec-headr">
                    <ul class="number_box fjhgf">
                        <li><a href="https://www.facebook.com/DigiRushSolutionLLP" bis_skin_checked="1"><i class="fa-brands fa-square-facebook"></i></a></li>
                        <li><a href="https://in.linkedin.com/company/digirushsolutions" bis_skin_checked="1"><i class="fa-brands fa-linkedin"></i></a></li>
                        <li><a href="https://x.com/i/flow/login?redirect_after_login=%2FDigirush_"  bis_skin_checked="1"><i class="fa-brands fa-twitter"></i></a></li>
                        <li><a href="https://www.instagram.com/digirushsolutions/" bis_skin_checked="1"><i class="fa-brands fa-instagram"></i></a></li>
                        <li><a href="https://www.youtube.com/@digirushsolutions" bis_skin_checked="1"><i class="fa-brands fa-youtube"></i></a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="navigation-wrapper">
        <div class="container">
            <div class="navigation-inner">
                <div class="site-logo">
                    <a href="{{ route('home') }}"><img src="{{custom_asset('front_assets/img/F-Logo.png')}}" alt="digirusholution"></a>
                </div>
                        ...
                        <!-- <li><a href="{{ route('digital_marketing') }}">Digital Marketing</a>
                            <ul>
                                <li>
                                    ...
                                    <ul>
                                        <li><a href="{{ route('local_seo_company') }}">Local SEO</a></li>
                                        <li><a href="{{ route('shopify_seo') }}">eCommerce SEO</a></li>
                                ...
                                <li><a href="{{ route('ppc_expert') }}">PPC Service</a></li>
                                <li><a href="{{ route('content_management') }}">Content Management Marketing</a></li>
                            </ul>
                        </li>
                  
                        <li><a href="{{ route('web_services') }}">Web Services</a>
                            <ul>
                                <li><a href="{{ route('web_development') }}">Web Development</a>
                                </li>
                                <li><a href="{{ route('web_designing') }}">Web Design</a>
...
<li class="dropdown">
  <div class="dropdown-toggle">
    <a href="#" class="dropdown-link">Services <span><i class="fa-solid fa-caret-down"></i></span></a>
  </div>
  <div class="dropdown-menu">
    <div class="dropdown-columns">
      <!-- <div class="column">
        <h4>Digital Marketing</h4>
        <a href="{{ route('local-seo') }}">Local SEO</a>
        <a href="">E-commerce SEO </a>
        <a href="{{ route('mobile-seo') }}">Mobile SEO </a>
        <a href="">PPC Services </a>
        <a href="{{ route('content-marketing') }}">Content Marketing</a>
      </div> -->
<div class="column">
  <h4>Digital Marketing</h4>

  <div class="submenu-wrapper">
    <a href="{{ route('local_seo_company') }}" class="has-submenu">
     <img src="{{custom_asset('front_assets/img/seo-services-icon.png')}}" alt="digirusholution"> 
     SEO Services
     <span class="arrow"><i class="fas fa-chevron-right"></i></span>
    </a>
    <div class="submenu">
      <a href="{{ route('local_seo_company') }}"> <img src="{{custom_asset('front_assets/img/local-seo.png')}}" alt="digirusholution"> Local SEO</a>
      <a href="{{ route('shopify_seo') }}"> <img src="{{custom_asset('front_assets/img/ecommerce-seo.png')}}" alt="digirusholution"> E-commerce SEO</a>
      <a href="{{ route('mobile-seo') }}"> <img src="{{custom_asset('front_assets/img/seo-services-icon.png')}}" alt="digirusholution"> Mobile SEO</a>
    </div>
  </div>

  <a href="{{ route('ppc_expert') }}"> <img src="{{custom_asset('front_assets/img/link.png')}}" alt="digirusholution"> PPC Services</a>
  <a href="{{ route('social_media_marketing') }}"> <img src="{{custom_asset('front_assets/img/social-media-marketing-icon.png')}}" alt="digirusholution"> Social Media Marketing</a>
  @foreach ($header_data->where('title', 'Digital Marketing')->where('type','header')->where('status','1')->unique() as $header)
    <a href="{{ route('dynamic_page',['slugs'=>$header->slug]) }}"><img src="{{ custom_asset($header->icon) }}" alt="digirusholution">
    {{ $header->header }}
    </a>                            
  @endforeach
  
  <!-- <a href="{{ route('content-marketing') }}"> <img src="{{custom_asset('front_assets/img/content-marketing.png')}}" alt="digirusholution"> Content Marketing</a> -->
</div>
      <div class="column">
        <h4>Web Development</h4>
        
        <a href="{{ route('web_development') }}"><img src="{{custom_asset('front_assets/img/web-development-icon.png')}}" alt="digirusholution"> Web Development</a>
        @foreach ($header_data->where('title', 'Web Development')->where('type','header')->where('status','1')->unique() as $header)
            <a href="{{ route('dynamic_page',['slugs'=>$header->slug]) }}"><img src="{{ custom_asset($header->icon) }}" alt="digirusholution">
            {{ $header->header }}
            </a>                            
        @endforeach
      ...
      <div class="column">
        <h4>Web Design</h4>
        <a href="{{ route('web_designing') }}"><img src="{{custom_asset('front_assets/img/web-design-icon.png')}}" alt="digirusholution">Web Design</a>
        @foreach ($header_data->where('title', 'Web Design')->where('type','header')->where('status','1')->unique() as $header)
            <a href="{{ route('dynamic_page',['slugs'=>$header->slug]) }}"><img src="{{ custom_asset($header->icon) }}" alt="digirusholution">
            {{ $header->header }}
            </a> 
        @endforeach
      ...
      <div class="column">
        <h4>Branding</h4>
        @foreach ($header_data->where('title','Branding')->where('type','header')->where('status','1')->unique() as $header)
            <a href="{{ route('dynamic_page',['slugs'=>$header->slug]) }}"><img src="{{ custom_asset($header->icon) }}" alt="digirusholution">
            {{ $header->header }}
            </a> 
        @endforeach
                ...
                <div class="header-right">
                    <ul> 
                        <li class="d-none d-lg-block">
                            @if(Route::currentRouteName() !== 'hire-developers')
                                <a href="{{ route('hire-developers') }}" class="default-btn">Hire Us Now</a>
                            @endif
                        </li>
...
<section class="button_fixed">
       ...
       <div class="fixed_button_call">
        <div class="call-now-wrapper">
            ...
            <div class="call-now-box">
              ...
              <div class="call-now-item">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="Layer_1" x="0px" y="0px" viewBox="0 0 55.2 38.4" style="enable-background:new 0 0 55.2 38.4" xml:space="preserve">
                    <style type="text/css">
                    .st0 {
                        fill: #B22234;
                    }
      ...
      <section class="whatsap_Sec">
        <div id="container">
            ...
            <a href="https://api.whatsapp.com/send?phone=+91 99159 54999&amp;text= Help For Loan Suvidha" target="_blank">
                    <svg width="80" height="80" xmlns="http://www.w3.org/2000/svg" xmlns:svg="http://www.w3.org/2000/svg">
                        <g class="layer">
                            <circle cx="40" cy="40" fill="#fff" id="svg_1" r="30" stroke="#000000" stroke-width="0"></circle>
