                ...
                <div class="card-body">
                    <form id="add_form" class="form-horizontal" action="{{ route('dynamic.store') }}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <textarea class="form-control" id="editor3" rows="3" name="meta_description"></textarea>
                            </div>
                        </div><br>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <div class="input-group" data-toggle="aizuploader" data-type="image">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text bg-soft-secondary font-weight-medium">
                                            <input type="file" id="fancy-file-upload" name="first_section_image"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <textarea class="form-control" id="editor4" rows="3"
                                    name="second_section_description"></textarea>
                            </div>
                        </div><br>
