            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form id="add_form" class="form-horizontal" action="{{ route('blog.store') }}"
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label">Video Link<small>(https://digirushsolutions.com/blogs)</small>
                            </label>
                            <div class="col-md-9">
                                <input type="text" placeholder="Video Link" name="video_link" id="video_link" class="form-control"
