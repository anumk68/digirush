    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form id="add_form" class="form-horizontal" action="{{ route('case.update',$case->id) }}" enctype="multipart/form-data" method="POST">
                        @csrf
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" value="{{ $case->title }}" placeholder="Title"
                                    onkeyup="makeSlug(this.value)" id="title" name="title" class="form-control"
                                    value="{{ old('title') }}" readonly>
                            </div>
                        </div><br>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" value="{{ $case->slug }}" placeholder="slug" id="slug" name="slug" class="form-control"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                ...
                                <div class="file-preview box sm">
                                    <img src="{{ asset('public/' . $case->banner) }}" alt="digirush"
