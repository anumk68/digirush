...
@section('content')
          ...
          <main class="page-content">
              <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3">General Inquery</div>
                    <div class="ps-3">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                            <li class="breadcrumb-item"><a href="javascript:void(0);"><i class="bx bx-home-alt"></i></a>
                            </li>
                            <li class="breadcrumb-item active" aria-current="page">General Inquery View</li>
                            </ol>
                        </nav>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <a href="{{ route('general-index') }}" class="btn btn-primary ms-auto">Back to List</a>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <h6 class="mb-1"><strong>Service</strong></h6>
                                    <p>{{ $data->service }}</p>
                                </div>
                                <div class="col-md-12">
